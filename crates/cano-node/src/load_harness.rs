...
//!
//! ```ignore
//! use cano_node::load_harness::{LoadHarnessConfig, LoadGenerator, run_load_harness};
//!
//! #[tokio::test]
...
//!
//! ```bash
//! LOAD_HARNESS_MESSAGES=1000 LOAD_HARNESS_RATE=100 cargo test -p cano-node load_harness
//! ```
//!
//! # Metrics Exposure
//!
...
///
/// ```ignore
/// use cano_node::load_harness::{LoadHarnessConfig, run_load_harness};
///
/// #[tokio::test]
/// async fn load_test() {
///     let config = LoadHarnessConfig::default()
...
mod tests {
    ...
    fn load_generator_respects_vote_ratio() {
        ...
        assert!(vote_ratio >= 0.6 && vote_ratio <= 0.8);
    }
