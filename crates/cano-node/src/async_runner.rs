//! Tokio-driven async node runner for cano post-quantum blockchain.
//!
...
//!
//! ```ignore
//! use cano_node::async_runner::{AsyncNodeRunner, ConsensusEvent, ConsensusEventSender};
//! use cano_node::NodeHotstuffHarness;
...
pub enum ConsensusEvent {
    ...
    /// `cano-consensus::network` to avoid creating redundant message types.
    ///
