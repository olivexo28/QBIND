...
//! - `CANO_CONSENSUS_EVENT_CHANNEL_CAPACITY`: ConsensusEvent channel
//! - `CANO_OUTBOUND_COMMAND_CHANNEL_CAPACITY`: Outbound command channel
//! - `CANO_ASYNC_PEER_INBOUND_CAPACITY`: AsyncPeerManager inbound channel
//! - `CANO_ASYNC_PEER_OUTBOUND_CAPACITY`: AsyncPeerManager per-peer outbound
//!
...
use cano_runtime::{BlockExecutionResult, BlockExecutor};
