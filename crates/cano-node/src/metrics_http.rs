...
//! use cano_node::metrics_http::{MetricsHttpConfig, spawn_metrics_http_server};
//!
//! #[tokio::main]
//! async fn main() {
...
//!
//! Set `CANO_METRICS_HTTP_ADDR` to enable the server:
//! - `CANO_METRICS_HTTP_ADDR=127.0.0.1:9100` - Enable on localhost:9100
...
use cano_consensus::ConsensusSigMetrics;
...
pub const METRICS_HTTP_ADDR_ENV: &str = "CANO_METRICS_HTTP_ADDR";
...
impl MetricsHttpConfig {
    ...
    ///
    /// ```bash
    /// CANO_METRICS_HTTP_ADDR=127.0.0.1:9100 cargo run
    /// ```
