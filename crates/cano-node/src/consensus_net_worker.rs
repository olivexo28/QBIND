//! Async consensus network worker for cano post-quantum blockchain.
//!
...
//!
//! ```ignore
//! use cano_node::consensus_net_worker::{ConsensusNetWorker, ConsensusNetService};
//! use cano_node::async_runner::{AsyncNodeRunner, ConsensusEventSender};
//!
...
///
/// ```ignore
/// use cano_node::consensus_net_worker::{AsyncConsensusNetAdapter, ConsensusNetService};
///
/// // Create the adapter
...
///
/// ```ignore
/// use cano_node::consensus_net_worker::{
...
use cano_consensus::ConsensusNetwork;
...
mod tests {
    use super::testing::*;
    use super::*;
    use cano_wire::consensus::{BlockHeader, Vote};
    use tokio::sync::mpsc;
