...
use cano_crypto::{ConsensusSigSuiteId, ValidatorSigningKey};
...
///
/// ```ignore
/// use cano_node::validator_config::LocalValidatorIdentity;
/// use cano_consensus::{ValidatorId, ValidatorPublicKey};
///
...
///
/// ```ignore
/// use cano_node::validator_config::ValidatorKeystoreConfig;
/// use std::path::PathBuf;
///
/// let keystore_cfg = ValidatorKeystoreConfig {
///     keystore_root: PathBuf::from("/etc/cano/keystore"),
...
///
/// This matches `cano_crypto::SUITE_PQ_RESERVED_1` (100).
...
pub fn make_test_local_validator_config(
    ...
    use cano_crypto::ml_dsa44::ML_DSA_44_SECRET_KEY_SIZE;
...
mod tests {
    ...
    fn validator_keystore_config_creation() {
        ...
        assert_eq!(config.keystore_root, PathBuf::from("/etc/cano/keystore"));
