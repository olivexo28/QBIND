...
//! ## Serialization
//!
//! Uses existing wire encoding from cano-wire, which ensures suite_id
...
use cano_wire::consensus::{BlockProposal, QuorumCertificate};
...
///
/// ```ignore
/// use cano_node::storage::RocksDbConsensusStorage;
...
///
/// ```ignore
/// use cano_node::storage::{ensure_compatible_schema, RocksDbConsensusStorage};
///
/// let storage = RocksDbConsensusStorage::open("/path/to/db")?;
