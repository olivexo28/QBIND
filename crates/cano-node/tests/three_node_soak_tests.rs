...
//! ```bash
//! # Run all soak tests
//! cargo test -p cano-node --test three_node_soak_tests
//!
//! # Run ignored (long) soak tests
//! cargo test -p cano-node --test three_node_soak_tests -- --ignored
//! ```
...
///
/// Run with: `cargo test -p cano-node --test three_node_soak_tests -- --ignored`
#[test]
#[ignore]
