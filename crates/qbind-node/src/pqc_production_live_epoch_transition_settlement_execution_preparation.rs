...
pub const PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_PROTOCOL_VERSION: u16 =
    1;

/// Run 337 — runtime handoff content digest domain tag.
pub const PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_INTENT_DOMAIN_TAG:
    &str = "QBIND:337-epoch-transition-settlement-preparation-intent:v1";
...
pub const PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_REQUEST_DOMAIN_TAG:
    &str = "QBIND:337-epoch-transition-settlement-preparation-request:v1";
...
pub struct ProductionLiveEpochTransitionSettlementExecutionPreparationConfig {
    ...
    pub protocol_version:
        ProductionLiveEpochTransitionSettlementExecutionPreparationProtocolVersion,
    /// The boundary kind.
...
impl ProductionLiveEpochTransitionSettlementExecutionPreparationConfig {
    pub fn new(
        kind: ProductionLiveEpochTransitionSettlementExecutionPreparationExecutorKind,
    ) -> Self {
        Self {
            protocol_version:
...
impl ProductionLiveEpochTransitionSettlementExecutionPreparationInputs {
    ...
    pub fn is_well_formed(&self) -> bool {
        !self.trust_domain.chain_id.is_empty()
            ...
            && !self
                .expected_settlement_preparation_intent_digest
                .is_empty()
            && !self
                .expected_settlement_preparation_transcript_digest
                .is_empty()
...
impl ProductionLiveEpochTransitionSettlementExecutionPreparationArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        h.update(
            PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_INTENT_DOMAIN_TAG
                .as_bytes(),
        );
...
pub fn production_live_epoch_transition_settlement_execution_preparation_request_id(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_REQUEST_DOMAIN_TAG
            .as_bytes(),
    );
...
pub fn production_live_epoch_transition_settlement_execution_preparation_transcript_digest(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_PREPARATION_TRANSCRIPT_DOMAIN_TAG
            .as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
...
pub enum ProductionLiveEpochTransitionSettlementExecutionPreparationOutcome {
    ...
    LiveEpochTransitionSettlementExecutionPreparationAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionSettlementExecutionPreparationDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.settlement_execution_preparation_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionSettlementExecutionPreparationExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::GovernanceProofWithoutSettlementPreparation => Err(O::GovernanceProofAloneRejected),
    ...
    fn check_application_binding(
        ...
        if decision.settlement_preparation_digest
            != inputs.expected_settlement_preparation_intent_digest
        {
    ...
    fn evaluate_core<R: LiveEpochTransitionSettlementExecutionPreparationReplaySet + ?Sized>(
        ...
        let mut record = ProductionLiveEpochTransitionSettlementExecutionPreparationArtifact {
            ...
            settlement_execution_preparation_policy_id: inputs
                .settlement_execution_preparation_policy_id
                .clone(),
        ...
        let settlement_execution_preparation_id =
...
pub fn production_live_epoch_transition_settlement_execution_preparation_executor_default_is_disabled(
) -> bool {
...
pub fn production_live_epoch_transition_settlement_execution_preparation_executor_mainnet_refused(
) -> bool {
    true
}
...
/// non-mutating.
pub fn production_live_epoch_transition_settlement_execution_preparation_executor_is_non_mutating(
) -> bool {
    true
}
...
pub fn production_live_epoch_transition_settlement_execution_preparation_executor_never_falls_back(
) -> bool {
    true
}
...
impl LiveEpochTransitionSettlementExecutionPreparationFixtureState {
    ...
    pub fn has_applied(&self, settlement_execution_preparation_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == settlement_execution_preparation_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(settlement_execution_preparation_id.to_string());
        true
    }
}
