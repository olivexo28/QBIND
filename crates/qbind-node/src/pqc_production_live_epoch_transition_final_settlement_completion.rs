...
impl ProductionLiveEpochTransitionFinalSettlementCompletionInputs {
    ...
    pub fn is_well_formed(&self) -> bool {
        !self.trust_domain.chain_id.is_empty()
            ...
            && !self
                .expected_settlement_execution_transcript_digest
                .is_empty()
...
pub enum ProductionLiveEpochTransitionFinalSettlementCompletionOutcome {
    ...
    LiveEpochTransitionFinalSettlementCompletionAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionFinalSettlementCompletionOutcome {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            Self::SettlementExecutionDecisionIdMismatch => {
                "settlement-execution-decision-id-mismatch"
            }
...
impl ProductionLiveEpochTransitionFinalSettlementCompletionDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.final_settlement_completion_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionFinalSettlementCompletionExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::GovernanceProofWithoutSettlementExecution => Err(O::GovernanceProofAloneRejected),
    ...
    fn check_application_binding(
        ...
        if decision.settlement_execution_digest
            != inputs.expected_settlement_execution_intent_digest
        {
    ...
    fn evaluate_core<R: LiveEpochTransitionFinalSettlementCompletionReplaySet + ?Sized>(
        ...
        let staged_application_id =
            production_live_epoch_transition_final_settlement_completion_request_id(
        ...
        let mut record = ProductionLiveEpochTransitionFinalSettlementCompletionArtifact {
            ...
            final_settlement_completion_policy_id: inputs
                .final_settlement_completion_policy_id
                .clone(),
        ...
        let final_settlement_completion_id =
            production_live_epoch_transition_final_settlement_completion_id(
                self.config.protocol_version.0,
                &decision.settlement_execution_digest,
                &inputs.final_settlement_completion_policy_id,
                request.proposed_epoch_transition_target,
...
pub fn production_live_epoch_transition_final_settlement_completion_executor_default_is_disabled(
) -> bool {
...
pub fn production_live_epoch_transition_final_settlement_completion_executor_mainnet_refused(
) -> bool {
    true
}
...
/// non-mutating.
pub fn production_live_epoch_transition_final_settlement_completion_executor_is_non_mutating(
) -> bool {
    true
}
...
pub fn production_live_epoch_transition_final_settlement_completion_executor_never_falls_back(
) -> bool {
    true
}
...
impl LiveEpochTransitionFinalSettlementCompletionFixtureState {
    ...
    pub fn has_applied(&self, final_settlement_completion_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == final_settlement_completion_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(final_settlement_completion_id.to_string());
        true
    }
}
