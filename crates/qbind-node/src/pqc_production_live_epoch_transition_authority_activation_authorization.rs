...
pub struct ProductionLiveEpochTransitionAuthorityActivationAuthorizationConfig {
    ...
    pub protocol_version:
        ProductionLiveEpochTransitionAuthorityActivationAuthorizationProtocolVersion,
    /// The boundary kind.
...
impl ProductionLiveEpochTransitionAuthorityActivationAuthorizationConfig {
    pub fn new(
        kind: ProductionLiveEpochTransitionAuthorityActivationAuthorizationExecutorKind,
    ) -> Self {
        Self {
            protocol_version:
...
impl ProductionLiveEpochTransitionAuthorityActivationAuthorizationInputs {
    ...
    pub fn is_well_formed(&self) -> bool {
        !self.trust_domain.chain_id.is_empty()
            ...
            && !self
                .expected_post_completion_attestation_decision_id
                .is_empty()
            && !self
                .expected_post_completion_attestation_request_id
                .is_empty()
            && !self
                .expected_post_completion_attestation_intent_digest
                .is_empty()
            && !self
                .expected_post_completion_attestation_transcript_digest
                .is_empty()
...
impl ProductionLiveEpochTransitionAuthorityActivationAuthorizationArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        h.update(
            PRODUCTION_LIVE_EPOCH_TRANSITION_POST_COMPLETION_ATTESTATION_INTENT_DOMAIN_TAG
                .as_bytes(),
        );
        ...
        hash_field(
            ...
            self.post_completion_attestation_transcript_digest
                .as_bytes(),
        );
        hash_field(
            &mut h,
...
pub fn production_live_epoch_transition_authority_activation_authorization_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_POST_COMPLETION_ATTESTATION_ID_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
        b"guarded_mutation_intent_digest",
...
pub fn production_live_epoch_transition_authority_activation_authorization_transcript_digest(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_POST_COMPLETION_ATTESTATION_TRANSCRIPT_DOMAIN_TAG
            .as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
...
pub enum ProductionLiveEpochTransitionAuthorityActivationAuthorizationOutcome {
    ...
    LiveEpochTransitionAuthorityActivationAuthorizationAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionAuthorityActivationAuthorizationDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.authority_activation_authorization_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionAuthorityActivationAuthorizationExecutor {
    ...
    fn preflight_gate(
        ...
        if self.policy.is_production() {
            return Some(
                O::ProductionLiveEpochTransitionAuthorityActivationAuthorizationUnavailable,
            );
        }
    ...
    fn check_application_binding(
        ...
        // transcript binding.
        if decision.post_completion_attestation_id
            != inputs.expected_post_completion_attestation_decision_id
        {
        ...
        if decision.post_completion_attestation_digest
            != inputs.expected_post_completion_attestation_intent_digest
        {
            return Some(O::PostCompletionAttestationDecisionIntentDigestMismatch);
        }
        if decision.transcript_digest
            != inputs.expected_post_completion_attestation_transcript_digest
        {
        ...
        // nonce binding.
        if intent.post_completion_attestation_nonce
            != inputs.expected_post_completion_attestation_nonce
        {
    ...
    fn evaluate_core<R: LiveEpochTransitionAuthorityActivationAuthorizationReplaySet + ?Sized>(
        ...
        let staged_application_id =
            production_live_epoch_transition_authority_activation_authorization_request_id(
        ...
        let mut record = ProductionLiveEpochTransitionAuthorityActivationAuthorizationArtifact {
            ...
            authority_activation_authorization_policy_id: inputs
                .authority_activation_authorization_policy_id
                .clone(),
            ...
            post_completion_attestation_decision_id: decision
                .post_completion_attestation_id
                .clone(),
            post_completion_attestation_request_id: decision.request_id.clone(),
            post_completion_attestation_intent_digest: decision
            ...
            authority_activation_authorization_nonce: request
                .authority_activation_authorization_nonce,
            // Exact future-executor preconditions.
        ...
        let authority_activation_authorization_id =
            production_live_epoch_transition_authority_activation_authorization_id(
                self.config.protocol_version.0,
                &decision.post_completion_attestation_digest,
                &inputs.authority_activation_authorization_policy_id,
                request.proposed_epoch_transition_target,
    ...
    >(
        ...
        if let Some(pkg) = &record {
            return ProductionLiveEpochTransitionAuthorityActivationAuthorizationDecision {
                outcome,
                authority_activation_authorization_id: pkg
                ...
                authority_activation_authorization_digest: pkg
...
pub fn production_live_epoch_transition_authority_activation_authorization_executor_default_is_disabled(
) -> bool {
...
pub fn production_live_epoch_transition_authority_activation_authorization_executor_mainnet_refused(
) -> bool {
    true
}
...
/// non-mutating.
pub fn production_live_epoch_transition_authority_activation_authorization_executor_is_non_mutating(
) -> bool {
    true
}
...
pub fn production_live_epoch_transition_authority_activation_authorization_executor_never_falls_back(
) -> bool {
    true
}
...
impl LiveEpochTransitionAuthorityActivationAuthorizationFixtureState {
    ...
    pub fn has_applied(&self, authority_activation_authorization_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == authority_activation_authorization_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(authority_activation_authorization_id.to_string());
        true
    }
}
