...
//! ```ignore
//! use std::sync::Arc;
//! use qbind_node::startup_validation::{ConsensusStartupValidator, SuitePolicy};
//!
...
pub enum StartupValidationError {
    ...
    MissingKeyForValidator(qbind_consensus::ids::ValidatorId),
    ...
    UnknownSuiteForValidator {
        validator_id: qbind_consensus::ids::ValidatorId,
        suite_id: u16,
    },
    ...
    StrayGovernanceKey(qbind_consensus::ids::ValidatorId),
    ...
    MixedSuitesInEpoch {
        epoch_id: qbind_consensus::validator_set::EpochId,
...
impl SuitePolicy {
    ...
    pub fn check_transition_allowed(
        ...
        use qbind_crypto::suite_catalog::{effective_security_bits, find_suite};
            ...
            if let Some(info) = from_info {
                if info.is_toy {
                    return Err(StartupValidationError::SuiteDowngradeAcrossEpochs {
                        from_epoch: qbind_consensus::validator_set::EpochId::new(0), // placeholder, will be filled by caller
                        to_epoch: qbind_consensus::validator_set::EpochId::new(0),
                        from_suite,
                        to_suite,
                    });
                }
    ...
    CS: ConsensusStorage + Send + Sync,
{
    ...
    pub fn validate_epoch(
        &self,
        epoch_state: &qbind_consensus::validator_set::EpochState,
        check_stray_keys: bool,
    ) -> Result<(), StartupValidationError> {
        // Create a suite checker using the backend registry
        let is_known_suite = |suite_id: qbind_crypto::ConsensusSigSuiteId| {
    ...
    fn validate_suite_for_validator(
        ...
        use qbind_crypto::suite_catalog::{find_suite, suite_name};
    ...
    fn convert_epoch_error(
        err: qbind_consensus::validator_set::EpochValidationError,
    ) -> StartupValidationError {
        use qbind_consensus::validator_set::EpochValidationError;
    ...
    pub fn validate_epoch_sequence(
        &self,
        epochs: &[qbind_consensus::validator_set::EpochState],
        ...
        let get_epoch_suite =
            |epoch: &qbind_consensus::validator_set::EpochState| -> Option<ConsensusSigSuiteId> {
