...
impl ProductionLiveEpochTransitionMutationExecutionExecutorKind {
    ...
    pub const fn is_source_test(self) -> bool {
        matches!(self, Self::SourceTestLiveEpochTransitionMutationExecution)
    }
}
...
impl ProductionLiveEpochTransitionMutationExecutionArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_MUTATION_EXECUTION_INTENT_DOMAIN_TAG.as_bytes());
...
pub fn production_live_epoch_transition_mutation_execution_request_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_MUTATION_EXECUTION_REQUEST_DOMAIN_TAG.as_bytes());
...
pub fn production_live_epoch_transition_mutation_execution_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_MUTATION_EXECUTION_ID_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
        b"guarded_mutation_intent_digest",
...
pub fn production_live_epoch_transition_mutation_execution_transcript_digest(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_MUTATION_EXECUTION_TRANSCRIPT_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
...
pub enum ProductionLiveEpochTransitionMutationExecutionOutcome {
    ...
    LiveEpochTransitionMutationExecutionAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
pub struct ProductionLiveEpochTransitionMutationExecutionDecision {
    ...
    pub execution_id: String,
    pub request_id: String,
    pub execution_artifact: Option<ProductionLiveEpochTransitionMutationExecutionArtifact>,
    pub execution_digest: String,
    pub transcript_digest: String,
}
...
impl ProductionLiveEpochTransitionMutationExecutionExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::GovernanceProofWithoutExecutionPreparation => Err(O::GovernanceProofAloneRejected),
    ...
    fn evaluate_core<R: LiveEpochTransitionMutationExecutionReplaySet + ?Sized>(
        ...
        let staged_kind = LiveEpochTransitionMutationExecutionKind::from_staged_application_kind(
