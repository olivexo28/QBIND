...
impl ProductionLiveEpochTransitionCommitExecutionArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        h.update(
            PRODUCTION_LIVE_EPOCH_TRANSITION_COMMIT_EXECUTION_INTENT_DOMAIN_TAG.as_bytes(),
        );
...
pub fn production_live_epoch_transition_commit_execution_request_id(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_COMMIT_EXECUTION_REQUEST_DOMAIN_TAG.as_bytes(),
    );
...
pub fn production_live_epoch_transition_commit_execution_id(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_COMMIT_EXECUTION_ID_DOMAIN_TAG.as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
    ...
    hash_field(&mut h, b"commit_execution_policy_id", commit_execution_policy_id.as_bytes());
    hash_field(
        &mut h,
        b"epoch_transition_target",
        &epoch_transition_target.to_le_bytes(),
...
pub fn production_live_epoch_transition_commit_execution_transcript_digest(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_COMMIT_EXECUTION_TRANSCRIPT_DOMAIN_TAG.as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
...
pub enum ProductionLiveEpochTransitionCommitExecutionOutcome {
    ...
    LiveEpochTransitionCommitExecutionAmbiguous { reason: String },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionCommitExecutionOutcome {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            Self::CommitAuthorizationDecisionIdMismatch => "commit-authorization-decision-id-mismatch",
...
impl ProductionLiveEpochTransitionCommitExecutionExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::GovernanceProofWithoutCommitAuthorization => {
    ...
    fn check_application_binding(
        ...
        if decision.commit_authorization_digest != inputs.expected_commit_authorization_intent_digest {
    ...
    fn evaluate_core<R: LiveEpochTransitionCommitExecutionReplaySet + ?Sized>(
        ...
        let staged_kind =
            LiveEpochTransitionCommitExecutionKind::from_staged_application_kind(
...
pub fn production_live_epoch_transition_commit_execution_executor_no_default_runtime_wiring(
) -> bool {
    true
}
...
impl LiveEpochTransitionCommitExecutionFixtureState {
    ...
    pub fn has_applied(&self, commit_execution_id: &str) -> bool {
        self.applied_execution_ids.iter().any(|id| id == commit_execution_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids.push(commit_execution_id.to_string());
        true
    }
}