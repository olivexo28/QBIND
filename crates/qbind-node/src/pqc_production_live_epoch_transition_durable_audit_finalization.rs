...
use crate::pqc_production_live_epoch_transition_post_commit_audit::{
    LiveEpochTransitionPostCommitAuditKind, ProductionLiveEpochTransitionPostCommitAuditArtifact,
...
impl ProductionLiveEpochTransitionDurableAuditFinalizationArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        h.update(
            PRODUCTION_LIVE_EPOCH_TRANSITION_DURABLE_AUDIT_FINALIZATION_INTENT_DOMAIN_TAG
                .as_bytes(),
        );
...
pub fn production_live_epoch_transition_durable_audit_finalization_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_DURABLE_AUDIT_FINALIZATION_ID_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
        b"guarded_mutation_intent_digest",
...
pub fn production_live_epoch_transition_durable_audit_finalization_transcript_digest(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_DURABLE_AUDIT_FINALIZATION_TRANSCRIPT_DOMAIN_TAG
            .as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
...
pub enum ProductionLiveEpochTransitionDurableAuditFinalizationOutcome {
    ...
    LiveEpochTransitionDurableAuditFinalizationAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionDurableAuditFinalizationDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.durable_audit_finalization_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionDurableAuditFinalizationExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::MissingPostCommitAuditDecision => Err(O::VerifiedPostCommitAuditDecisionRequired),
            ...
            S::GovernanceProofWithoutPostCommitAudit => Err(O::GovernanceProofAloneRejected),
    ...
    fn evaluate_core<R: LiveEpochTransitionDurableAuditFinalizationReplaySet + ?Sized>(
        ...
        let mut record = ProductionLiveEpochTransitionDurableAuditFinalizationArtifact {
            ...
            durable_audit_finalization_policy_id: inputs
                .durable_audit_finalization_policy_id
                .clone(),
        ...
        let durable_audit_finalization_id =
...
pub fn production_live_epoch_transition_durable_audit_finalization_executor_default_is_disabled(
) -> bool {
...
pub fn production_live_epoch_transition_durable_audit_finalization_executor_never_falls_back(
) -> bool {
    true
}
...
impl LiveEpochTransitionDurableAuditFinalizationFixtureState {
    ...
    pub fn has_applied(&self, durable_audit_finalization_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == durable_audit_finalization_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(durable_audit_finalization_id.to_string());
        true
    }
}
