...
use crate::pqc_production_epoch_transition_runtime_handoff::{
    ...
    EpochTransitionRuntimeHandoffKind,
};
...
impl LiveEpochTransitionExecutionPreparationKind {
    ...
    pub const fn from_staged_application_kind(
        kind: EpochTransitionRuntimeHandoffKind,
    ) -> Self {
...
pub fn production_live_epoch_transition_execution_preparation_request_id(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_EXECUTION_PREPARATION_REQUEST_DOMAIN_TAG.as_bytes(),
    );
...
pub fn production_live_epoch_transition_execution_preparation_id(
    ...
    let mut h = Sha3_256::new();
    h.update(
        PRODUCTION_LIVE_EPOCH_TRANSITION_EXECUTION_PREPARATION_ID_DOMAIN_TAG.as_bytes(),
    );
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
    ...
    hash_field(&mut h, b"preparation_policy_id", preparation_policy_id.as_bytes());
    hash_field(
        &mut h,
        b"epoch_transition_target",
        &epoch_transition_target.to_le_bytes(),
...
pub enum ProductionLiveEpochTransitionExecutionPreparationOutcome {
    ...
    LiveEpochTransitionExecutionPreparationAmbiguous { reason: String },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionExecutionPreparationExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::MissingRuntimeHandoffDecision => {
            ...
            S::ApplicationDecisionWithoutRuntimeHandoff => {
            ...
            S::GovernanceProofWithoutRuntimeHandoff => {
    ...
    fn evaluate_core<R: LiveEpochTransitionExecutionPreparationReplaySet + ?Sized>(
        ...
        let staged_application_id = production_live_epoch_transition_execution_preparation_request_id(
        ...
        let staged_kind =
            LiveEpochTransitionExecutionPreparationKind::from_staged_application_kind(
