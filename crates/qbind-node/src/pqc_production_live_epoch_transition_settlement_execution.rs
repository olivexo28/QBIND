...
impl ProductionLiveEpochTransitionSettlementExecutionExecutorKind {
    ...
    pub const fn is_source_test(self) -> bool {
        matches!(self, Self::SourceTestLiveEpochTransitionSettlementExecution)
    }
}
...
impl ProductionLiveEpochTransitionSettlementExecutionInputs {
    ...
    pub fn is_well_formed(&self) -> bool {
        !self.trust_domain.chain_id.is_empty()
            ...
            && !self
                .expected_settlement_execution_preparation_decision_id
                .is_empty()
            && !self
                .expected_settlement_execution_preparation_request_id
                .is_empty()
            && !self
                .expected_settlement_execution_preparation_intent_digest
                .is_empty()
            && !self
                .expected_settlement_execution_preparation_transcript_digest
                .is_empty()
...
impl ProductionLiveEpochTransitionSettlementExecutionArtifact {
    ...
    pub fn content_digest(&self) -> String {
        ...
        hash_field(
            ...
            self.settlement_execution_preparation_intent_digest
                .as_bytes(),
        );
        hash_field(
            &mut h,
            b"settlement_execution_preparation_transcript_digest",
            self.settlement_execution_preparation_transcript_digest
                .as_bytes(),
        );
        hash_field(
            &mut h,
...
pub fn production_live_epoch_transition_settlement_execution_request_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_REQUEST_DOMAIN_TAG.as_bytes());
...
pub fn production_live_epoch_transition_settlement_execution_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_SETTLEMENT_EXECUTION_ID_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
        b"guarded_mutation_intent_digest",
...
pub enum ProductionLiveEpochTransitionSettlementExecutionOutcome {
    ...
    LiveEpochTransitionSettlementExecutionAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionSettlementExecutionOutcome {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            Self::SettlementExecutionPreparationDecisionIdMismatch => {
                "settlement-execution-preparation-decision-id-mismatch"
            }
            ...
            Self::WrongSettlementExecutionPreparationNonce => {
                "wrong-settlement-execution-preparation-nonce"
            }
...
impl ProductionLiveEpochTransitionSettlementExecutionDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.settlement_execution_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionSettlementExecutionExecutor {
    ...
    > {
        ...
        match source {
            ...
            S::RotationPlanWithoutSettlementExecutionPreparation => {
    ...
    fn check_application_binding(
        ...
        // transcript binding.
        if decision.settlement_execution_preparation_id
            != inputs.expected_settlement_execution_preparation_decision_id
        {
        ...
        if decision.settlement_execution_preparation_digest
            != inputs.expected_settlement_execution_preparation_intent_digest
        {
            return Some(O::SettlementExecutionPreparationDecisionIntentDigestMismatch);
        }
        if decision.transcript_digest
            != inputs.expected_settlement_execution_preparation_transcript_digest
        {
        ...
        // nonce binding.
        if intent.settlement_execution_preparation_nonce
            != inputs.expected_settlement_execution_preparation_nonce
        {
    ...
    fn evaluate_core<R: LiveEpochTransitionSettlementExecutionReplaySet + ?Sized>(
        ...
        let staged_application_id =
            production_live_epoch_transition_settlement_execution_request_id(
        ...
        let staged_kind = LiveEpochTransitionSettlementExecutionKind::from_staged_application_kind(
        ...
        let mut record = ProductionLiveEpochTransitionSettlementExecutionArtifact {
            ...
            settlement_execution_preparation_decision_id: decision
                .settlement_execution_preparation_id
                .clone(),
            settlement_execution_preparation_request_id: decision.request_id.clone(),
            settlement_execution_preparation_intent_digest: decision
            ...
            settlement_execution_preparation_nonce: application_intent
...
impl LiveEpochTransitionSettlementExecutionFixtureState {
    ...
    pub fn has_applied(&self, settlement_execution_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == settlement_execution_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(settlement_execution_id.to_string());
        true
    }
}
