...
impl ProductionLiveEpochTransitionExternalPublicationExecutorKind {
    ...
    pub const fn is_source_test(self) -> bool {
        matches!(self, Self::SourceTestLiveEpochTransitionExternalPublication)
    }
}
...
impl ProductionLiveEpochTransitionExternalPublicationInputs {
    ...
    pub fn is_well_formed(&self) -> bool {
        !self.trust_domain.chain_id.is_empty()
            ...
            && !self
                .expected_durable_audit_publication_decision_id
                .is_empty()
            && !self
                .expected_durable_audit_publication_request_id
                .is_empty()
            && !self
                .expected_durable_audit_publication_intent_digest
                .is_empty()
            && !self
                .expected_durable_audit_publication_transcript_digest
                .is_empty()
...
pub fn production_live_epoch_transition_external_publication_request_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_EXTERNAL_PUBLICATION_REQUEST_DOMAIN_TAG.as_bytes());
...
pub fn production_live_epoch_transition_external_publication_id(
    ...
    use sha3::{Digest, Sha3_256};
    let mut h = Sha3_256::new();
    h.update(PRODUCTION_LIVE_EPOCH_TRANSITION_EXTERNAL_PUBLICATION_ID_DOMAIN_TAG.as_bytes());
    hash_field(&mut h, b"protocol_version", &protocol_version.to_le_bytes());
    hash_field(
        &mut h,
        b"guarded_mutation_intent_digest",
...
pub enum ProductionLiveEpochTransitionExternalPublicationOutcome {
    ...
    LiveEpochTransitionExternalPublicationAmbiguous {
        reason: String,
    },
    MainNetRefused,
}
...
impl ProductionLiveEpochTransitionExternalPublicationOutcome {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            Self::DurableAuditPublicationDecisionIdMismatch => {
                "durable-audit-publication-decision-id-mismatch"
            }
...
impl ProductionLiveEpochTransitionExternalPublicationDecision {
    ...
    pub fn authorizes_future_mutation_only(&self) -> bool {
        self.outcome.authorizes_future_mutation_only()
            && self.external_publication_artifact.is_some()
    }
}
...
impl ProductionLiveEpochTransitionExternalPublicationExecutor {
    ...
    fn check_application_binding(
        ...
        // transcript binding.
        if decision.durable_audit_publication_id
            != inputs.expected_durable_audit_publication_decision_id
        {
        ...
        if decision.durable_audit_publication_digest
            != inputs.expected_durable_audit_publication_intent_digest
        {
    ...
    fn evaluate_core<R: LiveEpochTransitionExternalPublicationReplaySet + ?Sized>(
        ...
        let staged_application_id =
            production_live_epoch_transition_external_publication_request_id(
        ...
        let staged_kind = LiveEpochTransitionExternalPublicationKind::from_staged_application_kind(
        ...
        let mut record = ProductionLiveEpochTransitionExternalPublicationArtifact {
            ...
            durable_audit_publication_intent_digest: decision
...
impl LiveEpochTransitionExternalPublicationFixtureState {
    ...
    pub fn has_applied(&self, external_publication_id: &str) -> bool {
        self.applied_execution_ids
            .iter()
            .any(|id| id == external_publication_id)
    }
    ...
    pub fn apply_prepared_execution(
        ...
        self.applied_execution_ids
            .push(external_publication_id.to_string());
        true
    }
}
