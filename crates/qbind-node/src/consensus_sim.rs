...
//!
//! This is the node-side analogue of `SingleNodeSim` from `qbind-consensus`,
//! but uses real networking instead of `MockConsensusNetwork`.
//!
//! # Usage
//!
//! ```ignore
//! use qbind_consensus::{HotStuffDriver, HotStuffState};
...
use qbind_consensus::driver::DrainableCommitLog;
use qbind_consensus::{
...
///
/// This struct mirrors `SingleNodeSim` from `qbind-consensus`, but uses real
