...
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_remove, Sc::Remove);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_update, Sc::Update);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_noop, Sc::NoOp);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_identity, Sc::Identity);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_retire, Sc::Retire);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_emergency, Sc::Emergency);
per_scenario_execution_preparation_binding!(scenario_execution_preparation_binding_authsync, Sc::AuthSync);
...
fn main() {
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        ("accepted_compatible", "accept_artifact_reexposes_consumed_execution_preparation_transcript", accept_artifact_reexposes_consumed_execution_preparation_transcript as fn()),
        ...
        ("rejection_fail_closed", "wrong_execution_preparation_decision_id", wrong_execution_preparation_decision_id as fn()),
        ("rejection_fail_closed", "wrong_execution_preparation_request_id", wrong_execution_preparation_request_id as fn()),
        ("rejection_fail_closed", "wrong_execution_preparation_intent_digest", wrong_execution_preparation_intent_digest as fn()),
        ("rejection_fail_closed", "wrong_execution_preparation_transcript_digest", wrong_execution_preparation_transcript_digest as fn()),
        ("rejection_fail_closed", "wrong_execution_preparation_nonce", wrong_execution_preparation_nonce as fn()),
        ("rejection_fail_closed", "tampered_execution_preparation_package_integrity_mismatch", tampered_execution_preparation_package_integrity_mismatch as fn()),
        ...
        ("rejection_fail_closed", "reject_missing_execution_preparation_decision", reject_missing_execution_preparation_decision as fn()),
        ("rejection_fail_closed", "reject_unverified_execution_preparation_decision", reject_unverified_execution_preparation_decision as fn()),
        ...
        ("rejection_fail_closed", "reject_accepted_execution_preparation_without_package_via_verified_source", reject_accepted_execution_preparation_without_package_via_verified_source as fn()),
        ("rejection_fail_closed", "reject_accepted_execution_preparation_without_package_variant", reject_accepted_execution_preparation_without_package_variant as fn()),
        ...
        ("rejection_fail_closed", "reject_fixture_only_execution_preparation", reject_fixture_only_execution_preparation as fn()),
        ...
        ("rejection_fail_closed", "scenario_execution_preparation_binding_add", scenario_execution_preparation_binding_add as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_remove", scenario_execution_preparation_binding_remove as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_update", scenario_execution_preparation_binding_update as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_noop", scenario_execution_preparation_binding_noop as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_identity", scenario_execution_preparation_binding_identity as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_retire", scenario_execution_preparation_binding_retire as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_emergency", scenario_execution_preparation_binding_emergency as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_authsync", scenario_execution_preparation_binding_authsync as fn()),
        ("rejection_fail_closed", "scenario_execution_preparation_binding_bulk", scenario_execution_preparation_binding_bulk as fn()),
    ...
    let clean: ProductionLiveEpochTransitionMutationExecutionRecoveryOutcome =
        recover_exec.recover_live_epoch_transition_mutation_execution_window(
            None,
            current_artifact,
        );
    let idempotent: ProductionLiveEpochTransitionMutationExecutionRecoveryOutcome =
        recover_exec.recover_live_epoch_transition_mutation_execution_window(
    ...
    summary.push_str("run_318_production_live_epoch_transition_mutation_execution_release_binary_helper\n");
