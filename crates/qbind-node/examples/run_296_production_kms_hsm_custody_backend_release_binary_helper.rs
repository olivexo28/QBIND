...
use qbind_node::pqc_production_kms_hsm_custody_backend::{
    ...
    KmsHsmCustodyProviderTransport, MockKmsHsmCustodyTransport, ProductionCustodyError,
    ProductionCustodyOutcome, ProductionCustodyProviderKind, ProductionCustodyProviderStub,
    ProductionCustodyRecoveryOutcome, ProductionCustodyRequestKind, ProductionCustodyRequestSpec,
...
fn main() {
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        (
            "accepted_compatible",
            "a02_devnet_fixture_kms_accepts_under_fixture_policy",
            a02_devnet_fixture_kms_accepts_under_fixture_policy as fn(),
        ),
        (
            "accepted_compatible",
            "a03_devnet_fixture_hsm_accepts_under_fixture_policy",
            a03_devnet_fixture_hsm_accepts_under_fixture_policy as fn(),
        ),
        (
            "accepted_compatible",
            "a04_testnet_fixture_kms_accepts_under_allowed_policy",
            a04_testnet_fixture_kms_accepts_under_allowed_policy as fn(),
        ),
        (
            "accepted_compatible",
            "a05_testnet_fixture_hsm_accepts_under_allowed_policy",
            a05_testnet_fixture_hsm_accepts_under_allowed_policy as fn(),
        ),
        (
            "accepted_compatible",
            "a06_production_cloud_kms_request_built_without_fixture_fallback",
            a06_production_cloud_kms_request_built_without_fixture_fallback as fn(),
        ),
        (
            "accepted_compatible",
            "a07_production_pkcs11_hsm_request_built_without_fixture_fallback",
            a07_production_pkcs11_hsm_request_built_without_fixture_fallback as fn(),
        ),
        (
            "accepted_compatible",
            "a08_production_generic_kms_request_built_without_fixture_fallback",
            a08_production_generic_kms_request_built_without_fixture_fallback as fn(),
        ),
        (
            "accepted_compatible",
            "a09_production_cloud_kms_path_reachable_and_fail_closed",
            a09_production_cloud_kms_path_reachable_and_fail_closed as fn(),
        ),
        (
            "accepted_compatible",
            "a10_production_pkcs11_hsm_path_reachable_and_fail_closed",
            a10_production_pkcs11_hsm_path_reachable_and_fail_closed as fn(),
        ),
        (
            "accepted_compatible",
            "a11_request_id_is_deterministic",
            a11_request_id_is_deterministic as fn(),
        ),
        (
            "accepted_compatible",
            "a12_response_digest_is_deterministic",
            a12_response_digest_is_deterministic as fn(),
        ),
        (
            "accepted_compatible",
            "a13_transcript_digest_is_deterministic",
            a13_transcript_digest_is_deterministic as fn(),
        ),
        (
            "accepted_compatible",
            "a14_two_identical_requests_produce_identical_digests",
            a14_two_identical_requests_produce_identical_digests as fn(),
        ),
        (
            "accepted_compatible",
            "a15_valid_fixture_response_authorizes_matching_request",
            a15_valid_fixture_response_authorizes_matching_request as fn(),
        ),
        (
            "accepted_compatible",
            "a16_run203_verifier_composition_is_exercised",
            a16_run203_verifier_composition_is_exercised as fn(),
        ),
        (
            "accepted_compatible",
            "a17_provider_kind_maps_to_backend_kind_run203_compatible",
            a17_provider_kind_maps_to_backend_kind_run203_compatible as fn(),
        ),
        (
            "accepted_compatible",
            "a18_protocol_version_constant_is_stable",
            a18_protocol_version_constant_is_stable as fn(),
        ),
        (
            "rejection_fail_closed",
            "b01_disabled_policy_no_request_no_provider_invocation",
            b01_disabled_policy_no_request_no_provider_invocation as fn(),
        ),
        (
            "rejection_fail_closed",
            "b02_mainnet_identity_refused_before_provider",
            b02_mainnet_identity_refused_before_provider as fn(),
        ),
        (
            "rejection_fail_closed",
            "b03_fixture_kms_material_refused_for_mainnet",
            b03_fixture_kms_material_refused_for_mainnet as fn(),
        ),
        (
            "rejection_fail_closed",
            "b04_fixture_hsm_material_refused_for_mainnet",
            b04_fixture_hsm_material_refused_for_mainnet as fn(),
        ),
        (
            "rejection_fail_closed",
            "b05_remote_signer_material_cannot_satisfy_kms_hsm",
            b05_remote_signer_material_cannot_satisfy_kms_hsm as fn(),
        ),
        (
            "rejection_fail_closed",
            "b06_local_operator_material_refused",
            b06_local_operator_material_refused as fn(),
        ),
        (
            "rejection_fail_closed",
            "b07_wrong_environment_rejected",
            b07_wrong_environment_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b08_wrong_chain_rejected",
            b08_wrong_chain_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b09_wrong_genesis_rejected",
            b09_wrong_genesis_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b10_wrong_authority_root_rejected",
            b10_wrong_authority_root_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b11_wrong_authority_sequence_rejected",
            b11_wrong_authority_sequence_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b12_wrong_provider_kind_rejected",
            b12_wrong_provider_kind_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b13_wrong_key_handle_rejected",
            b13_wrong_key_handle_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b14_wrong_signer_identity_rejected",
            b14_wrong_signer_identity_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b15_wrong_request_id_rejected",
            b15_wrong_request_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b16_wrong_transcript_digest_rejected",
            b16_wrong_transcript_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
        ...
        (
            "rejection_fail_closed",
            "b19_wrong_protocol_version_rejected",
            b19_wrong_protocol_version_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b20_missing_signature_rejected",
            b20_missing_signature_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b21_missing_attestation_rejected",
            b21_missing_attestation_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b22_attestation_unavailable_fail_closed",
            b22_attestation_unavailable_fail_closed as fn(),
        ),
        (
            "rejection_fail_closed",
            "b23_malformed_response_rejected",
            b23_malformed_response_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b24_oversized_response_rejected",
            b24_oversized_response_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b25_response_replay_from_prior_request_rejected",
            b25_response_replay_from_prior_request_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b26_provider_unavailable_rejected",
            b26_provider_unavailable_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b27_provider_timeout_rejected",
            b27_provider_timeout_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b28_provider_decode_error_rejected",
            b28_provider_decode_error_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b29_provider_refused_rejected",
            b29_provider_refused_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b30_provider_policy_rejected_rejected",
            b30_provider_policy_rejected_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b31_unsupported_provider_rejected",
            b31_unsupported_provider_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b32_endpoint_unavailable_rejected",
            b32_endpoint_unavailable_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b33_attestation_missing_provider_error_rejected",
            b33_attestation_missing_provider_error_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b34_validator_set_rotation_request_unsupported",
            b34_validator_set_rotation_request_unsupported as fn(),
        ),
        (
            "rejection_fail_closed",
            "b35_policy_change_request_unsupported",
            b35_policy_change_request_unsupported as fn(),
        ),
        (
            "rejection_fail_closed",
            "b36_onchain_governance_proof_request_unavailable",
            b36_onchain_governance_proof_request_unavailable as fn(),
        ),
        (
        ...
        (
            "mainnet_authority_policy",
            "c03_mainnet_cannot_be_satisfied_by_remote_signer_only",
            c03_mainnet_cannot_be_satisfied_by_remote_signer_only as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c04_mainnet_cannot_be_satisfied_by_local_operator_material",
            c04_mainnet_cannot_be_satisfied_by_local_operator_material as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c05_mainnet_peer_majority_material_refused",
            c05_mainnet_peer_majority_material_refused as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c06_mainnet_production_policy_unavailable_no_provider_call",
            c06_mainnet_production_policy_unavailable_no_provider_call as fn(),
        ),
        (
            "mainnet_authority_policy",
        ...
        (
            "mainnet_authority_policy",
            "c08_mainnet_production_custody_unavailable_records_no_mutation",
            c08_mainnet_production_custody_unavailable_records_no_mutation as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c09_mainnet_scope_helper_refuses_fixture_material",
            c09_mainnet_scope_helper_refuses_fixture_material as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d01_no_prior_request_window",
            d01_no_prior_request_window as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d02_duplicate_identical_request_is_idempotent",
            d02_duplicate_identical_request_is_idempotent as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d03_same_id_different_transcript_fails_closed",
            d03_same_id_different_transcript_fails_closed as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d04_same_id_different_key_handle_fails_closed",
            d04_same_id_different_key_handle_fails_closed as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d05_same_request_different_response_fails_closed",
            d05_same_request_different_response_fails_closed as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d06_different_request_ids_are_unrelated_windows",
            d06_different_request_ids_are_unrelated_windows as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d07_recovery_idempotency_is_byte_identical_only",
            d07_recovery_idempotency_is_byte_identical_only as fn(),
        ),
        (
            "non_mutation",
            "e01_every_outcome_is_non_mutating",
            e01_every_outcome_is_non_mutating as fn(),
        ),
        (
            "non_mutation",
            "e02_disabled_reject_touches_no_provider",
            e02_disabled_reject_touches_no_provider as fn(),
        ),
        (
            "non_mutation",
            "e03_reject_after_verify_adds_no_provider_call",
            e03_reject_after_verify_adds_no_provider_call as fn(),
        ),
        (
            "non_mutation",
            "e04_non_mutation_scope_helpers_hold",
            e04_non_mutation_scope_helpers_hold as fn(),
        ),
        (
            "non_mutation",
            "e05_source_test_scope_flag_holds",
            e05_source_test_scope_flag_holds as fn(),
        ),
        (
            "reachability",
    ...
    summary
        .push_str("Run 296 production KMS/HSM/cloud-KMS/PKCS#11 custody backend release helper\n");
