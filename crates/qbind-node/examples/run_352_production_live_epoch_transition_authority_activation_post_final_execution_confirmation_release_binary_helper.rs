//! Run 352 — release-binary evidence helper for the Run 351 live epoch-transition
...
//! release-built production library symbols. It exercises the **real** Run 351
...
//! 327 -> 329 -> 331 -> 333 -> 335 -> 337 -> 339 -> 341 -> 343 -> 345 -> 347 -> 349 chain
//! to produce a verified, accepted Run 349/350 live epoch-transition
//! authority-activation final-execution decision (`is_accept()` with
//! `Some(authority_activation_final_execution_artifact)`), then feeds that
//! decision into the Run 351 live epoch-transition authority-activation
//! post-final-execution confirmation / execution-sink-readiness executor, which
//! emits only a typed, deterministic, non-mutating authority-activation
//! post-final-execution confirmation / execution-sink-readiness artifact.
//!
...
//! post-final-execution confirmation / execution-sink-readiness artifacts; it
//! never applies a live validator-set change, never transitions a consensus
//! epoch, never commits or finalizes production runtime state, never writes a
//! production receipt / audit / audit-seal / audit-finalization / audit-ledger /
...
//! / final-execution / post-final-execution-confirmation / execution-sink /
//! publication / external-publication record, never calls Run 070, never mutates
...
//!
//! See `docs/devnet/QBIND_DEVNET_EVIDENCE_RUN_352.md`.
#![allow(dead_code)]
...
mod run_349_authority_activation_final_execution {
    ...
    pub fn helper_main() {
        let outdir = std::env::args()
            ...
            .unwrap_or_else(|| {
                std::path::PathBuf::from(
                    "docs/devnet/run_352_production_live_epoch_transition_authority_activation_post_final_execution_confirmation_release_binary/helper_evidence/run_352",
                )
            });
        ...
        let cases: &[(&str, &str, fn())] = &[
            ...
            ("accepted_compatible", "accept_artifact_reexposes_consumed_authority_activation_final_execution_transcript", accept_artifact_reexposes_consumed_authority_activation_final_execution_transcript as fn()),
            ...
            ("rejection_fail_closed", "wrong_authority_activation_final_execution_decision_id", wrong_authority_activation_final_execution_decision_id as fn()),
            ("rejection_fail_closed", "wrong_authority_activation_final_execution_request_id", wrong_authority_activation_final_execution_request_id as fn()),
            ("rejection_fail_closed", "wrong_authority_activation_final_execution_intent_digest", wrong_authority_activation_final_execution_intent_digest as fn()),
            ("rejection_fail_closed", "wrong_authority_activation_final_execution_transcript_digest", wrong_authority_activation_final_execution_transcript_digest as fn()),
            ("rejection_fail_closed", "wrong_authority_activation_final_execution_nonce", wrong_authority_activation_final_execution_nonce as fn()),
            ("rejection_fail_closed", "tampered_authority_activation_final_execution_package_integrity_mismatch", tampered_authority_activation_final_execution_package_integrity_mismatch as fn()),
            ...
            ("rejection_fail_closed", "reject_missing_authority_activation_final_execution_decision", reject_missing_authority_activation_final_execution_decision as fn()),
            ("rejection_fail_closed", "reject_unverified_authority_activation_final_execution_decision", reject_unverified_authority_activation_final_execution_decision as fn()),
            ...
            ("rejection_fail_closed", "reject_accepted_authority_activation_final_execution_without_package_via_verified_source", reject_accepted_authority_activation_final_execution_without_package_via_verified_source as fn()),
            ("rejection_fail_closed", "reject_accepted_authority_activation_final_execution_without_package_variant", reject_accepted_authority_activation_final_execution_without_package_variant as fn()),
            ...
            ("rejection_fail_closed", "reject_fixture_only_authority_activation_final_execution", reject_fixture_only_authority_activation_final_execution as fn()),
        ...
        let art2 = d2
            ...
            .expect("accepted artifact");
        assert_eq!(
            art1.authority_activation_post_final_execution_confirmation_id,
            art2.authority_activation_post_final_execution_confirmation_id
        );
        assert_eq!(art1.request_id, art2.request_id);
        assert_eq!(art1.content_digest(), art2.content_digest());
        assert_eq!(
            art1.authority_activation_post_final_execution_confirmation_digest,
            art2.authority_activation_post_final_execution_confirmation_digest
        );
        assert_eq!(art1.transcript_digest, art2.transcript_digest);

        std::fs::write(
            outdir.join("fixtures/run_352_accepted_artifact.txt"),
            format!(
        ...
        std::fs::write(
            outdir.join("fixtures/run_352_deterministic_digests.txt"),
            format!(
                "authority_activation_post_final_execution_confirmation_id={}\nrequest_id={}\ncontent_digest={}\nauthority_activation_post_final_execution_confirmation_digest={}\ntranscript_digest={}\nsecond_authority_activation_post_final_execution_confirmation_id={}\nsecond_request_id={}\nsecond_content_digest={}\nsecond_authority_activation_post_final_execution_confirmation_digest={}\nsecond_transcript_digest={}\n",
                art1.authority_activation_post_final_execution_confirmation_id,
                art1.request_id,
                art1.content_digest(),
                art1.authority_activation_post_final_execution_confirmation_digest,
        ...
        std::fs::write(
            outdir.join("fixtures/run_352_replay_recovery.txt"),
            format!("recovery={:?}\n", recovery),
        )
        ...
        summary.push_str("run=352\n");
        summary.push_str("boundary=crates/qbind-node/src/pqc_production_live_epoch_transition_authority_activation_post_final_execution_confirmation.rs::ProductionLiveEpochTransitionAuthorityActivationPostFinalExecutionConfirmationExecutor\n");
...
fn main() {
    run_349_authority_activation_final_execution::run_351_authority_activation_post_final_execution_confirmation::helper_main();
}