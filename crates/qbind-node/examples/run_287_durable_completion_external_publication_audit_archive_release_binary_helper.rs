...
use qbind_node::pqc_governance_durable_completion_external_publication_audit_archive::{
    ...
    DurableCompletionExternalPublicationAuditArchiveWindow,
    ExternalExternalPublicationAuditArchiveSink,
    FixtureDurableCompletionExternalPublicationAuditArchiveSink,
    GovernanceDurableCompletionExternalPublicationAuditArchiveSink,
    MainNetExternalPublicationAuditArchiveSink, ProductionExternalPublicationAuditArchiveSink,
};
...
fn ctx_action(
    ...
    let external_publication_audit_completion = attach_run284_external_publication_audit_completion(
        environment,
        action,
        consumer_duplicate,
    );
...
fn release_symbol_reachability_probe() {
    ...
    assert!(!outcome.no_commitment());
    assert_eq!(outcome.tag(), "external-publication-audit-archive-recorded");
    assert_eq!(
        sink.kind(),
        DurableCompletionExternalPublicationAuditArchiveKind::FixtureInMemory
    );
