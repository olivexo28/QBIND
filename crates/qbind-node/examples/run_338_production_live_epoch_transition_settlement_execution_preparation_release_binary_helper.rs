...
fn main() {
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        ("accepted_compatible", "accept_artifact_reexposes_consumed_settlement_preparation_transcript", accept_artifact_reexposes_consumed_settlement_preparation_transcript as fn()),
        ...
        ("rejection_fail_closed", "wrong_settlement_preparation_decision_id", wrong_settlement_preparation_decision_id as fn()),
        ("rejection_fail_closed", "wrong_settlement_preparation_request_id", wrong_settlement_preparation_request_id as fn()),
        ("rejection_fail_closed", "wrong_settlement_preparation_intent_digest", wrong_settlement_preparation_intent_digest as fn()),
        ("rejection_fail_closed", "wrong_settlement_preparation_transcript_digest", wrong_settlement_preparation_transcript_digest as fn()),
        ("rejection_fail_closed", "wrong_settlement_preparation_nonce", wrong_settlement_preparation_nonce as fn()),
        ("rejection_fail_closed", "tampered_settlement_preparation_package_integrity_mismatch", tampered_settlement_preparation_package_integrity_mismatch as fn()),
        ...
        ("rejection_fail_closed", "reject_missing_settlement_preparation_decision", reject_missing_settlement_preparation_decision as fn()),
        ("rejection_fail_closed", "reject_unverified_settlement_preparation_decision", reject_unverified_settlement_preparation_decision as fn()),
        ...
        ("rejection_fail_closed", "reject_accepted_settlement_preparation_without_package_via_verified_source", reject_accepted_settlement_preparation_without_package_via_verified_source as fn()),
        ("rejection_fail_closed", "reject_accepted_settlement_preparation_without_package_variant", reject_accepted_settlement_preparation_without_package_variant as fn()),
        ...
        ("rejection_fail_closed", "reject_fixture_only_settlement_preparation", reject_fixture_only_settlement_preparation as fn()),
    ...
    accepted_body.push_str(&format!("settlement_execution_preparation_id={}\n", accepted_decision.settlement_execution_preparation_id));
    ...
    accepted_body.push_str(&format!("settlement_execution_preparation_digest={}\n", accepted_decision.settlement_execution_preparation_digest));
    ...
    assert_eq!(digest_decision_1.settlement_execution_preparation_id, digest_decision_2.settlement_execution_preparation_id);
    ...
    assert_eq!(digest_decision_1.settlement_execution_preparation_digest, digest_decision_2.settlement_execution_preparation_digest);
    ...
    digest_body.push_str(&format!("settlement_execution_preparation_id={}\n", digest_decision_1.settlement_execution_preparation_id));
    ...
    digest_body.push_str(&format!("second_settlement_execution_preparation_digest={}\n", digest_decision_2.settlement_execution_preparation_digest));
    ...
    let recover_exec = ProductionLiveEpochTransitionSettlementExecutionPreparationExecutor::source_test();
    let current_artifact: &ProductionLiveEpochTransitionSettlementExecutionPreparationArtifact = accepted_artifact;
