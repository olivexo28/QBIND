//! Run 289 — release-binary durable-completion external-publication-audit-archive
//! consumer / external-publication-audit-seal boundary helper.
//!
//! Release-binary evidence for the Run 288 durable-completion external-publication
//! audit-archive consumer / external-publication-audit-seal boundary. This helper
//! is compiled as a release example and linked against the release-built
//! production library symbols. It attaches the real modeled chain Run 256 backend
...
//! external-publication confirmation -> Run 278 external-publication receipt ->
//! Run 280 external-publication acknowledgement -> Run 282 external-publication
//! audit finalization -> Run 284 external-publication audit completion -> Run 286
//! external-publication audit archive, and then evaluates the Run 288
//! external-publication-audit-seal boundary. Projection is intentionally from
//! `input.external_publication_audit_archive_binding` through
...
//! audit-seal path stays fixture/in-memory/dev-test only. No production runtime,
//! MainNet enablement, real settlement, or real external publication is enabled.
//! The fixture sink mutates only the in-memory
...
use qbind_node::pqc_governance_durable_completion_external_publication_audit_seal::{
    ...
    durable_completion_external_publication_audit_seal_ambiguous_window_fails_closed,
    durable_completion_external_publication_audit_seal_attestation_required,
    durable_completion_external_publication_audit_seal_backend_submission_required,
    durable_completion_external_publication_audit_seal_completion_report_required,
    durable_completion_external_publication_audit_seal_external_unavailable,
    durable_completion_external_publication_audit_seal_failed_record_never_records,
    ...
    durable_completion_external_publication_audit_seal_mainnet_peer_driven_apply_refused_first,
    ...
    durable_completion_external_publication_audit_seal_no_external_publication,
    durable_completion_external_publication_audit_seal_no_real_audit_ledger,
    durable_completion_external_publication_audit_seal_no_rocksdb_file_schema_migration_change,
    ...
    durable_completion_external_publication_audit_seal_record_required_before_reported,
    ...
    durable_completion_external_publication_audit_seal_validator_set_rotation_unsupported,
    ...
    durable_completion_external_publication_audit_seal_consumer_required,
    durable_completion_external_publication_audit_seal_confirmation_required,
    durable_completion_external_publication_audit_seal_no_real_settlement,
    durable_completion_external_publication_audit_seal_no_real_settlement_finality,
    durable_completion_external_publication_audit_seal_no_real_settlement_receipt,
    ...
    DurableCompletionExternalPublicationAuditSealBinding,
    DurableCompletionExternalPublicationAuditSealDigest,
    DurableCompletionExternalPublicationAuditSealEnvironment,
    DurableCompletionExternalPublicationAuditSealExpectations,
    DurableCompletionExternalPublicationAuditSealFault,
    ...
    DurableCompletionExternalPublicationAuditSealResponse,
    DurableCompletionExternalPublicationAuditSealSurface,
    DurableCompletionExternalPublicationAuditSealTranscriptDigest,
    DurableCompletionExternalPublicationAuditSealWindow, ExternalExternalPublicationAuditSealSink,
    FixtureDurableCompletionExternalPublicationAuditSealSink,
    GovernanceDurableCompletionExternalPublicationAuditSealSink, MainNetExternalPublicationAuditSealSink,
    ProductionExternalPublicationAuditSealSink,
};
...
use qbind_node::pqc_governance_durable_completion_external_publication_audit_archive::{
    ...
    durable_completion_external_publication_audit_archive_ambiguous_window_fails_closed,
    durable_completion_external_publication_audit_archive_attestation_required,
    durable_completion_external_publication_audit_archive_backend_submission_required,
    durable_completion_external_publication_audit_archive_completion_report_required,
    durable_completion_external_publication_audit_archive_external_unavailable,
    durable_completion_external_publication_audit_archive_failed_record_never_records,
    durable_completion_external_publication_audit_archive_finalization_projection_required,
    durable_completion_external_publication_audit_archive_local_operator_cannot_satisfy_mainnet_authority,
    durable_completion_external_publication_audit_archive_mainnet_peer_driven_apply_refused_first,
    ...
    durable_completion_external_publication_audit_archive_never_writes_sequence_or_marker,
    durable_completion_external_publication_audit_archive_no_external_publication,
    durable_completion_external_publication_audit_archive_no_real_audit_ledger,
    durable_completion_external_publication_audit_archive_no_rocksdb_file_schema_migration_change,
    durable_completion_external_publication_audit_archive_peer_majority_cannot_satisfy_mainnet_authority,
    durable_completion_external_publication_audit_archive_pipeline_success_required,
    durable_completion_external_publication_audit_archive_policy_change_unsupported,
    durable_completion_external_publication_audit_archive_production_mainnet_unavailable,
    durable_completion_external_publication_audit_archive_receipt_required,
    durable_completion_external_publication_audit_archive_record_required_before_reported,
    durable_completion_external_publication_audit_archive_rejection_is_non_mutating,
    durable_completion_external_publication_audit_archive_rollback_never_records,
    ...
    DurableCompletionExternalPublicationAuditArchiveFault,
    ...
    DurableCompletionExternalPublicationAuditArchiveWindow, ExternalExternalPublicationAuditArchiveSink,
...
struct ActionLabel {
    ...
    external_publication_audit_seal_record_id: String,
    proposal_id: String,
    decision_id: String,
...
fn action_label(label: &str) -> ActionLabel {
    ActionLabel {
        ...
        external_publication_audit_seal_record_id: format!(
            "durable-completion-external-publication-audit-seal-{label}"
        ),
...
// ===========================================================================
// Run 286 external_publication_audit_archive attachment (prior boundary)
// Builds a REAL Run 286 recorded outcome from the Run 280 prior. Uses the real
// Run 286 module field names so the Run 286 cur-layer can consume it.
// ===========================================================================
#[allow(dead_code)]
...
struct AttachedExternalPublicationAuditCompletion {
...
fn run284_confirmation_identity() -> DurableCompletionExternalPublicationAuditCompletionIdentity {
    DurableCompletionExternalPublicationAuditCompletionIdentity {
        confirmation_id: EXT_PUB_AUDIT_FINALIZATION_ID.to_string(),
        kind: DurableCompletionExternalPublicationAuditCompletionKind::FixtureInMemory,
        policy: DurableCompletionExternalPublicationAuditCompletionPolicy::FixtureAllowed,
        domain_separation_tag: EXT_PUB_AUDIT_FINALIZATION_DOMAIN_TAG.to_string(),
    }
}

fn attach_run284_external_publication_audit_completion(
    environment: TrustBundleEnvironment,
    action: &ActionLabel,
    confirmation_duplicate: bool,
) -> AttachedExternalPublicationAuditCompletion {
    let external_publication_audit_finalization =
        attach_run282_external_publication_audit_finalization(environment, action, false);
    ...
    let input = DurableCompletionExternalPublicationAuditCompletionInput {
        ...
        acknowledgement_binding: ack.outcome.clone(),
        consumer_binding: consumer.outcome.clone(),
        external_publication_audit_finalization_binding: external_publication_audit_finalization.outcome.clone(),
        request,
    };
    ...
    let record = ledger
        .find(&action.external_publication_audit_completion_record_id)
...
struct AttachedExternalPublicationAuditArchive {
...
fn run286_confirmation_identity() -> DurableCompletionExternalPublicationAuditArchiveIdentity {
    DurableCompletionExternalPublicationAuditArchiveIdentity {
        confirmation_id: ACKNOWLEDGEMENT_ID.to_string(),
        kind: DurableCompletionExternalPublicationAuditArchiveKind::FixtureInMemory,
        policy: DurableCompletionExternalPublicationAuditArchivePolicy::FixtureAllowed,
        domain_separation_tag: ACKNOWLEDGEMENT_DOMAIN_TAG.to_string(),
    }
}

fn attach_run286_external_publication_audit_archive(
    environment: TrustBundleEnvironment,
    action: &ActionLabel,
    confirmation_duplicate: bool,
) -> AttachedExternalPublicationAuditArchive {
    let external_publication_audit_completion =
        attach_run284_external_publication_audit_completion(environment, action, false);
    let consumer = external_publication_audit_completion.consumer.clone();
    let ack = &consumer.ack;
    let confirmation_env = match environment {
        TrustBundleEnvironment::Devnet | TrustBundleEnvironment::Testnet => environment,
        TrustBundleEnvironment::Mainnet => TrustBundleEnvironment::Devnet,
    ...
    let input = DurableCompletionExternalPublicationAuditArchiveInput {
        ...
        acknowledgement_binding: ack.outcome.clone(),
        consumer_binding: consumer.outcome.clone(),
        external_publication_audit_completion_binding: external_publication_audit_completion.outcome.clone(),
        request,
    };
    let mut ledger = DurableCompletionExternalPublicationAuditArchiveLedger::new();
    let mut sink = FixtureDurableCompletionExternalPublicationAuditArchiveSink::new();
    let first = evaluate_durable_completion_external_publication_audit_archive(
        &input,
        &expectations,
        &mut sink,
        &mut ledger,
    ...
    let outcome = if confirmation_duplicate {
        let second = evaluate_durable_completion_external_publication_audit_archive(
            &input,
            &expectations,
            &mut sink,
            &mut ledger,
    ...
    let record = ledger
        .find(&action.external_publication_audit_archive_record_id)
...
struct Ctx {
    ...
    consumer: AttachedConsumer,
    external_publication_audit_archive: AttachedExternalPublicationAuditArchive,
}

fn ack_identity(
    policy: DurableCompletionExternalPublicationAuditSealPolicy,
...
fn ctx_action(
    ...
    let external_publication_audit_archive =
        attach_run286_external_publication_audit_archive(environment, action, consumer_duplicate);
    let consumer = external_publication_audit_archive.consumer.clone();
    let ack = &consumer.ack;
    let env = ModeledGovernanceTrustMutationEnvironmentBinding {
        environment,
        chain_id: CHAIN.to_string(),
    ...
    let expectations = DurableCompletionExternalPublicationAuditSealExpectations {
        ...
        expected_external_publication_audit_seal_kind: kind,
        expected_external_publication_audit_seal_policy: policy,
...
impl Ctx {
    ...
    fn input_with_confirmation(
        ...
        external_publication_audit_seal: GovernanceModeledDurableCompletionFinalizationOutcome,
        ...
        external_publication_audit_archive: DurableCompletionExternalPublicationAuditArchiveOutcome,
    ) -> DurableCompletionExternalPublicationAuditSealInput {
        DurableCompletionExternalPublicationAuditSealInput {
            policy,
            ...
            confirmation_binding: external_publication_audit_seal,
            ...
            external_publication_audit_archive_binding: external_publication_audit_archive,
    ...
    fn input(
        ...
        self.input_with_confirmation(
            ...
            self.external_publication_audit_archive.outcome.clone(),
        )
    }

    fn recorded(&self) -> DurableCompletionExternalPublicationAuditSealInput {
        self.input_with_confirmation(
...
fn fixture_sink() -> FixtureDurableCompletionExternalPublicationAuditSealSink {
    FixtureDurableCompletionExternalPublicationAuditSealSink::new()
}
fn disabled_receipt_policy_preserves_legacy_bypass_no_record_no_invocation() {
    let c = devnet_ctx();
    let input = c.input(
        DurableCompletionExternalPublicationAuditSealPolicy::Disabled,
        DurableReplayObservation::MutationAuthorized,
        GovernanceModeledEndToEndPipelineOutcome::ModeledApplierAppliedAndDurableConsumeAuthorized,
        GovernanceModeledDurableConsumeSinkOutcome::ConsumeReceiptRecorded,
        GovernanceModeledDurableConsumeCompletionReporterOutcome::CompletionReportRecorded,
    ...
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = fixture_sink();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::LegacyBypassNoExternalPublicationAuditSeal
    );
...
fn disabled_backend_policy_never_invokes_receipt_sink() {
    ...
    let input = c.input_with_confirmation(
        ...
        DurableCompletionExternalPublicationAuditArchiveOutcome::LegacyBypassNoExternalPublicationAuditArchive,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = fixture_sink();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
...
fn devnet_fixture_chain_records_exactly_one_receipt_only_after_backend_submission() {
    ...
    assert!(external_publication_audit_seal_outcome_authorizes_record(&outcome));
    assert!(external_publication_audit_seal_outcome_projects_to_recorded(&outcome));
    assert_eq!(sink.invocations(), 1);
    assert_eq!(ledger.len(), 1);
    assert!(ledger.contains(AUDIT_FINALIZATION_RECORD_ID));
    assert_eq!(
        external_publication_audit_seal_identity_digest(&c.request.identity),
...
fn governance_action_variants_record_only_after_backend_submission() {
    ...
    for label in [
        ...
        assert_eq!(ledger.len(), 1);
        assert!(ledger.contains(&action.external_publication_audit_seal_record_id));
    }
}
...
fn duplicate_identical_receipt_is_idempotent() {
    ...
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = fixture_sink();
    let first = evaluate_durable_completion_external_publication_audit_seal(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    let second = evaluate_durable_completion_external_publication_audit_seal(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    assert!(!external_publication_audit_seal_outcome_authorizes_record(&second));
    assert!(external_publication_audit_seal_outcome_projects_to_recorded(&second));
    assert_eq!(ledger.len(), 1);
}

fn run268_duplicate_idempotent_confirmation_only_matches_existing_never_creates() {
    // A real Run 286 ExternalPublicationAuditArchiveDuplicateIdempotent outcome with
    // identical digests.
    ...
    assert_eq!(
        dup_ctx.external_publication_audit_archive.outcome,
        DurableCompletionExternalPublicationAuditArchiveOutcome::ExternalPublicationAuditArchiveDuplicateIdempotent
    );
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealRejectedBeforeRecord
    );
    assert!(ledger.is_empty());

    // After a real receipt records, the duplicate-idempotent backend matches it.
    let rec_ctx = devnet_ctx();
    let recorded = evaluate_durable_completion_external_publication_audit_seal(
        &rec_ctx.recorded(),
    ...
    let matched = evaluate_durable_completion_external_publication_audit_seal(
        &dup_ctx.recorded(),
        &dup_ctx.expectations,
        &mut sink,
        &mut ledger,
...
fn production_audit_ledger_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditSealPolicy::ProductionExternalPublicationAuditSealRequired,
        DurableCompletionExternalPublicationAuditSealKind::ProductionExternalPublicationAuditSealUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = ProductionExternalPublicationAuditSealSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn mainnet_audit_ledger_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditSealPolicy::MainNetExternalPublicationAuditSealRequired,
        DurableCompletionExternalPublicationAuditSealKind::MainNetExternalPublicationAuditSealUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = MainNetExternalPublicationAuditSealSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn external_publication_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditSealPolicy::ExternalExternalPublicationAuditSealRequired,
        DurableCompletionExternalPublicationAuditSealKind::ExternalExternalPublicationAuditSealUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = ExternalExternalPublicationAuditSealSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn validator_set_rotation_and_policy_change_unsupported() {
    ...
    let rotation = c.input_with_confirmation(
        ...
        DurableCompletionExternalPublicationAuditArchiveOutcome::ValidatorSetRotationUnsupportedNoAuditArchive,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = fixture_sink();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::ValidatorSetRotationUnsupportedNoAuditSeal
    );
    assert_eq!(sink.invocations(), 0);
    ...
    let policy_change = c.input_with_confirmation(
        ...
        c.consumer.ack.outcome.clone(),
        c.consumer.outcome.clone(),
        DurableCompletionExternalPublicationAuditArchiveOutcome::PolicyChangeUnsupportedNoAuditArchive,
    );
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &policy_change,
        &c.expectations,
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::PolicyChangeUnsupportedNoAuditSeal
    );
    assert_eq!(sink.invocations(), 0);
    assert!(ledger.is_empty());
}
...
fn assert_non_recording_confirmation(
    external_publication_audit_archive: DurableCompletionExternalPublicationAuditArchiveOutcome,
    expected: DurableCompletionExternalPublicationAuditSealOutcome,
) {
    let c = devnet_ctx();
    let input = c.input_with_confirmation(
        DurableCompletionExternalPublicationAuditSealPolicy::FixtureAllowed,
...
fn non_recording_confirmation_outcomes_never_record_external_publication_audit_seal() {
    ...
    assert_non_recording_confirmation(
        Finalization::ExternalPublicationAuditArchiveRejectedBeforeRecord,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalPublicationAuditArchiveRecordFailedNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalPublicationAuditArchiveRolledBackNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalPublicationAuditArchiveRollbackFailedFatalNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalPublicationAuditArchiveAmbiguousFailClosedNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ProductionExternalPublicationAuditArchiveUnavailableNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::MainNetExternalPublicationAuditArchiveUnavailableNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalExternalPublicationAuditArchiveUnavailableNoAuditArchive,
        Receipt::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::MainNetPeerDrivenApplyRefusedNoAuditArchive,
        Receipt::MainNetPeerDrivenApplyRefusedNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::ValidatorSetRotationUnsupportedNoAuditArchive,
        Receipt::ValidatorSetRotationUnsupportedNoAuditSeal,
    );
    assert_non_recording_confirmation(
        Finalization::PolicyChangeUnsupportedNoAuditArchive,
        Receipt::PolicyChangeUnsupportedNoAuditSeal,
    );
}
...
fn assert_binding_mismatch_rejected(mut mutate: impl FnMut(&mut Ctx)) {
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::RejectedBeforeExternalPublicationAuditArchiveNoAuditSeal
    );
    assert_eq!(sink.invocations(), 0);
    assert!(ledger.is_empty());
}
...
fn assert_request_mismatch_rejected(
    mut mutate: impl FnMut(&mut DurableCompletionExternalPublicationAuditSealRequest),
) {
    let c = devnet_ctx();
...
fn wrong_external_publication_audit_seal_record_id_rejected_before_record() {
    assert_request_mismatch_rejected(|r| {
        r.external_publication_audit_seal_record_id = "other-confirmation".to_string();
    });
}
...
fn same_ack_record_id_different_digest_is_equivocation_no_second_receipt() {
    ...
    let equivocation = evaluate_durable_completion_external_publication_audit_seal(
        &c2.recorded(),
        &c2.expectations,
        &mut sink,
        &mut ledger,
...
fn assert_fault_no_acknowledgement(
    fault: DurableCompletionExternalPublicationAuditSealFault,
    expected: DurableCompletionExternalPublicationAuditSealOutcome,
) {
    let c = devnet_ctx();
    let input = c.recorded();
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = FixtureDurableCompletionExternalPublicationAuditSealSink::with_fault(fault);
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &input,
        &c.expectations,
        &mut sink,
...
fn receipt_record_failed_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealRecordFailedNoAuditSeal,
    );
}
...
fn receipt_rollback_completed_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealRolledBackNoAuditSeal,
    );
}
...
fn receipt_rollback_failed_fatal_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealRollbackFailedFatalNoAuditSeal,
    );
}
...
fn receipt_ambiguous_window_fails_closed() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealAmbiguousFailClosedNoAuditSeal,
    );
}
...
fn only_recorded_confirmation_outcome_creates_external_publication_audit_seal_request_intent() {
    use DurableCompletionExternalPublicationAuditArchiveOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditSealRequestIntent as Intent;
    assert_eq!(
        project_external_publication_audit_archive_outcome_to_external_publication_audit_seal_request(
            &Finalization::ExternalPublicationAuditArchiveRecorded
        ),
        Intent::CreateRequest
    );
    assert!(project_external_publication_audit_archive_outcome_to_external_publication_audit_seal_request(
        &Finalization::ExternalPublicationAuditArchiveRecorded
    )
    .creates_request());
    assert_eq!(
        project_external_publication_audit_archive_outcome_to_external_publication_audit_seal_request(
            &Finalization::ExternalPublicationAuditArchiveDuplicateIdempotent
        ),
...
fn non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request() {
    use DurableCompletionExternalPublicationAuditArchiveOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditSealRequestIntent as Intent;
    for confirmation in [
        Finalization::LegacyBypassNoExternalPublicationAuditArchive,
        ...
        assert!(matches!(
            project_external_publication_audit_archive_outcome_to_external_publication_audit_seal_request(&confirmation),
            Intent::NoReceipt(_)
        ));
    }
}
...
fn recovered_ledger() -> DurableCompletionExternalPublicationAuditSealLedger {
    let c = devnet_ctx();
    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = fixture_sink();
    let _ = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut sink,
        &mut ledger,
...
fn assert_window(
    ...
    let outcome = recover_durable_completion_external_publication_audit_seal_window(
        &input,
        window,
        DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory,
        record,
...
fn pre_external_publication_audit_archive_windows_fail_closed_no_commitment() {
    ...
    for w in [
        ...
        assert_window(
            w,
            false,
            Finalization::ExternalPublicationAuditArchiveDidNotRecordNoAuditSeal,
        );
    }
}

fn after_external_publication_audit_archive_request_before_record_rejects_before_record() {
    use DurableCompletionExternalPublicationAuditSealOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditSealWindow as Window;
    assert_window(
        Window::AfterExternalPublicationAuditSealRequestBeforeExternalPublicationAuditSealRecord,
        false,
        Finalization::ExternalPublicationAuditSealRejectedBeforeRecord,
    );
}

fn after_external_publication_audit_archive_record_before_success_requires_explicit_matching_record() {
    use DurableCompletionExternalPublicationAuditSealOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditSealWindow as Window;
    assert_window(
...
fn after_external_publication_audit_archive_success_recovers_as_recorded() {
    use DurableCompletionExternalPublicationAuditSealOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditSealWindow as Window;
    assert_window(
        Window::AfterExternalPublicationAuditSealSuccess,
        true,
        Finalization::ExternalPublicationAuditSealRecorded,
    );
...
fn ambiguous_record_failed_rollback_and_unknown_windows_fail_closed() {
    ...
    assert_window(
        ...
        false,
        Finalization::ExternalPublicationAuditSealAmbiguousFailClosedNoAuditSeal,
    );
    assert_window(
        Window::Unknown,
        false,
    ...
    assert_window(
        ...
        false,
        Finalization::ExternalPublicationAuditSealRecordFailedNoAuditSeal,
    );
    assert_window(
        Window::ExternalPublicationAuditSealRollbackCompleted,
        false,
        Finalization::ExternalPublicationAuditSealRolledBackNoAuditSeal,
    );
    assert_window(
        Window::ExternalPublicationAuditSealRollbackFailed,
        false,
        Finalization::ExternalPublicationAuditSealRollbackFailedFatalNoAuditSeal,
    );
}
...
fn production_mainnet_external_recovery_classification_unavailable() {
    ...
    let outcome = recover_durable_completion_external_publication_audit_seal_window(
        &input,
        DurableCompletionExternalPublicationAuditSealWindow::AfterExternalPublicationAuditSealSuccess,
        DurableCompletionExternalPublicationAuditSealKind::ProductionExternalPublicationAuditSealUnavailable,
        None,
        &c.expectations,
    );
...
fn rollback_restores_receipt_ledger_snapshot() {
    ...
    let mut faulted = FixtureDurableCompletionExternalPublicationAuditSealSink::with_fault(
        DurableCompletionExternalPublicationAuditSealFault::RolledBackNoReceipt,
    );
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &c2.recorded(),
...
fn invariant_helpers_assert_fail_closed_contract() {
    assert!(durable_completion_external_publication_audit_seal_rejection_is_non_mutating());
    assert!(durable_completion_external_publication_audit_seal_never_calls_run_070());
    assert!(durable_completion_external_publication_audit_seal_never_mutates_live_pqc_trust_state());
    assert!(durable_completion_external_publication_audit_seal_never_writes_sequence_or_marker());
    assert!(durable_completion_external_publication_audit_seal_no_rocksdb_file_schema_migration_change());
    assert!(durable_completion_external_publication_audit_seal_no_external_publication());
    assert!(durable_completion_external_publication_audit_seal_no_real_audit_ledger());
    assert!(durable_completion_external_publication_audit_seal_pipeline_success_required());
    assert!(durable_completion_external_publication_audit_seal_sink_receipt_required());
    assert!(durable_completion_external_publication_audit_seal_completion_report_required());
    assert!(durable_completion_external_publication_audit_seal_finalization_projection_required());
    assert!(durable_completion_external_publication_audit_seal_attestation_required());
    assert!(durable_completion_external_publication_audit_seal_backend_submission_required());
    assert!(durable_completion_external_publication_audit_seal_receipt_required());
    assert!(durable_completion_external_publication_audit_seal_record_required_before_reported());
    assert!(durable_completion_external_publication_audit_seal_failed_record_never_records());
    assert!(durable_completion_external_publication_audit_seal_rollback_never_records());
    assert!(durable_completion_external_publication_audit_seal_ambiguous_window_fails_closed());
    assert!(
        durable_completion_external_publication_audit_seal_mainnet_peer_driven_apply_refused_first(
            TrustBundleEnvironment::Mainnet
        )
    ...
    assert!(durable_completion_external_publication_audit_seal_production_mainnet_unavailable());
    assert!(durable_completion_external_publication_audit_seal_external_unavailable());
    assert!(durable_completion_external_publication_audit_seal_validator_set_rotation_unsupported());
    assert!(durable_completion_external_publication_audit_seal_policy_change_unsupported());
    assert!(
        durable_completion_external_publication_audit_seal_local_operator_cannot_satisfy_mainnet_authority()
    );
    assert!(
...
fn release_symbol_reachability_probe() {
    let c = devnet_ctx();
    let input: DurableCompletionExternalPublicationAuditSealInput = c.recorded();
    ...
    assert!(matches!(
        intent,
        DurableCompletionExternalPublicationAuditSealRequestIntent::CreateRequest
    ));

    let mut ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let mut sink = FixtureDurableCompletionExternalPublicationAuditSealSink::new();
    let outcome = evaluate_durable_completion_external_publication_audit_seal(
        &input,
        &c.expectations,
        &mut sink,
    ...
    assert!(!outcome.no_commitment());
    assert_eq!(outcome.tag(), "external-publication-audit-seal-recorded");
    assert_eq!(
        sink.kind(),
        DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory
    );
    ...
    let identity_digest: DurableCompletionExternalPublicationAuditSealDigest =
        external_publication_audit_seal_identity_digest(&c.request.identity);
    let request_digest: DurableCompletionExternalPublicationAuditSealDigest =
        external_publication_audit_seal_request_digest(&c.request);
    let response = DurableCompletionExternalPublicationAuditSealResponse {
        external_publication_audit_seal_record_id: c
            .request
            .external_publication_audit_seal_record_id
            .clone(),
        request_digest: request_digest.clone(),
        accepted: true,
        external_publication_audit_seal_kind:
            DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory,
    };
    assert!(response.is_well_formed());
    let response_digest: DurableCompletionExternalPublicationAuditSealDigest =
        external_publication_audit_seal_response_digest(&response);
    let record: DurableCompletionExternalPublicationAuditSealRecord = c.request.to_record();
    let record_digest: DurableCompletionExternalPublicationAuditSealDigest =
        external_publication_audit_seal_record_digest(&record);
    let transcript_digest: DurableCompletionExternalPublicationAuditSealTranscriptDigest =
        external_publication_audit_seal_transcript_digest(
            &request_digest,
            &response_digest,
            &record_digest,
    ...
    let ledger_record: &DurableCompletionExternalPublicationAuditSealLedgerRecord = ledger
        .find(AUDIT_FINALIZATION_RECORD_ID)
        .expect("external-publication-audit-seal ledger record");
    assert_eq!(
        ledger_record.status,
        DurableCompletionExternalPublicationAuditSealLedgerStatus::Recorded
    );
    let snapshot: DurableCompletionExternalPublicationAuditSealLedgerSnapshot = ledger.snapshot();
    assert_eq!(snapshot.len(), 1);

    let _surface: DurableCompletionExternalPublicationAuditSealSurface = input.surface();
    let _environment: DurableCompletionExternalPublicationAuditSealEnvironment =
        input.environment_binding.clone();
    let _binding: DurableCompletionExternalPublicationAuditSealBinding =
        input.runtime_binding.clone();

    assert!(DurableCompletionExternalPublicationAuditSealPolicy::Disabled.is_disabled());
    assert!(DurableCompletionExternalPublicationAuditSealPolicy::FixtureAllowed.allows_fixture());
    assert_eq!(
        DurableCompletionExternalPublicationAuditSealPolicy::ProductionExternalPublicationAuditSealRequired.tag(),
        "production-external-publication-audit-seal-required"
    );
    assert!(DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory.is_fixture());
    assert!(DurableCompletionExternalPublicationAuditSealKind::ProductionExternalPublicationAuditSealUnavailable.is_unavailable());
    assert_eq!(
        DurableCompletionExternalPublicationAuditSealKind::Disabled.tag(),
        "disabled"
    );
    let legacy =
        DurableCompletionExternalPublicationAuditSealOutcome::LegacyBypassNoExternalPublicationAuditSeal;
    assert!(legacy.is_legacy_bypass());
    assert!(legacy.no_commitment());
    assert!(
        DurableCompletionExternalPublicationAuditSealOutcome::MainNetPeerDrivenApplyRefusedNoAuditSeal
            .is_mainnet_peer_driven_apply_refused()
    );

    // Recovery-window classifier reachability.
    let recovered = recover_durable_completion_external_publication_audit_seal_window(
        &input,
        DurableCompletionExternalPublicationAuditSealWindow::AfterExternalPublicationAuditSealSuccess,
        DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory,
        ledger.find(AUDIT_FINALIZATION_RECORD_ID),
    ...
    assert!(durable_completion_external_publication_audit_seal_no_external_publication());
    assert!(durable_completion_external_publication_audit_seal_no_real_audit_ledger());
    assert!(durable_completion_external_publication_audit_seal_consumer_required());
    assert!(durable_completion_external_publication_audit_seal_confirmation_required());
    assert!(durable_completion_external_publication_audit_seal_no_real_settlement());
    assert!(durable_completion_external_publication_audit_seal_no_real_settlement_finality());
    assert!(durable_completion_external_publication_audit_seal_no_real_settlement_receipt());
    assert!(durable_completion_external_publication_audit_seal_no_real_settlement_finality_projection());
    assert!(durable_completion_external_publication_audit_seal_no_real_external_publication_audit_archive());
    assert!(durable_completion_external_publication_audit_seal_no_real_external_publication_audit_seal());
    assert!(durable_completion_external_publication_audit_seal_record_required_before_reported());
    assert!(durable_completion_external_publication_audit_seal_failed_record_never_records());
    assert!(durable_completion_external_publication_audit_seal_rollback_never_records());
    assert!(durable_completion_external_publication_audit_seal_ambiguous_window_fails_closed());
    ...
    let mut prod = ProductionExternalPublicationAuditSealSink::default();
    let mut mainnet = MainNetExternalPublicationAuditSealSink::default();
    let mut external = ExternalExternalPublicationAuditSealSink::default();
    let mut prod_ledger = DurableCompletionExternalPublicationAuditSealLedger::new();
    let _ = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut prod,
    ...
    let mut prod_ledger2 = DurableCompletionExternalPublicationAuditSealLedger::new();
    let _ = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut mainnet,
    ...
    let mut prod_ledger3 = DurableCompletionExternalPublicationAuditSealLedger::new();
    let _ = evaluate_durable_completion_external_publication_audit_seal(
        &c.recorded(),
        &c.expectations,
        &mut external,
    ...
    // Production / MainNet / external audit-seal sinks are reachable but
    // unavailable/fail-closed and record no modeled state.
    assert!(prod_ledger.is_empty());
    assert!(prod_ledger2.is_empty());
    assert!(prod_ledger3.is_empty());
}
...
fn main() {
    let outdir = env::args().nth(1).map(PathBuf::from).unwrap_or_else(|| {
        PathBuf::from("docs/devnet/run_287_durable_completion_external_publication_audit_seal_release_binary/helper_evidence/run_289")
    });
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        ("rejection_fail_closed", "non_recording_confirmation_outcomes_never_record_external_publication_audit_seal", non_recording_confirmation_outcomes_never_record_external_publication_audit_seal as fn()),
        ...
        ("rejection_fail_closed", "wrong_external_publication_audit_seal_record_id_rejected_before_record", wrong_external_publication_audit_seal_record_id_rejected_before_record as fn()),
        ...
        ("rejection_fail_closed", "non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request", non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request as fn()),
        ...
        ("recovery_crash_window", "pre_external_publication_audit_archive_windows_fail_closed_no_commitment", pre_external_publication_audit_archive_windows_fail_closed_no_commitment as fn()),
        ("recovery_crash_window", "after_external_publication_audit_archive_request_before_record_rejects_before_record", after_external_publication_audit_archive_request_before_record_rejects_before_record as fn()),
        ("recovery_crash_window", "after_external_publication_audit_archive_record_before_success_requires_explicit_matching_record", after_external_publication_audit_archive_record_before_success_requires_explicit_matching_record as fn()),
        ("recovery_crash_window", "after_external_publication_audit_archive_success_recovers_as_recorded", after_external_publication_audit_archive_success_recovers_as_recorded as fn()),
        ...
        ("projection", "only_recorded_confirmation_outcome_creates_external_publication_audit_seal_request_intent", only_recorded_confirmation_outcome_creates_external_publication_audit_seal_request_intent as fn()),
        ("projection", "non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request", non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request as fn()),
        ...
        ("external_publication_audit_seal_ledger", "duplicate_identical_receipt_is_idempotent", duplicate_identical_receipt_is_idempotent as fn()),
        ("external_publication_audit_seal_ledger", "same_ack_record_id_different_digest_is_equivocation_no_second_receipt", same_ack_record_id_different_digest_is_equivocation_no_second_receipt as fn()),
        ("external_publication_audit_seal_ledger", "rollback_restores_receipt_ledger_snapshot", rollback_restores_receipt_ledger_snapshot as fn()),
        ...
        ("non_mutation", "non_recording_confirmation_outcomes_never_record_external_publication_audit_seal", non_recording_confirmation_outcomes_never_record_external_publication_audit_seal as fn()),
        ("non_mutation", "non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request", non_recording_confirmation_outcomes_create_no_external_publication_audit_seal_request as fn()),
    ...
    fs::write(
        outdir.join("fixtures/run_289_projection_rule.txt"),
        "input.external_publication_audit_archive_binding\nproject_external_publication_audit_archive_outcome_to_external_publication_audit_seal_request\nExternalPublicationAuditArchiveRecorded -> CreateRequest\n",
