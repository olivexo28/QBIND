...
mod run_339_settlement_execution {
    ...
    pub fn helper_main() {
        ...
        digest_body.push_str(&format!(
            "second_settlement_execution_id={}\n",
            digest_decision_2.settlement_execution_id
        ));
        digest_body.push_str(&format!(
            "second_request_id={}\n",
        ...
        digest_body.push_str(&format!(
            "second_settlement_execution_digest={}\n",
            digest_decision_2.settlement_execution_digest
        ));
        digest_body.push_str(&format!(
        ...
        let current_artifact: &ProductionLiveEpochTransitionSettlementExecutionArtifact =
            accepted_artifact;
        let clean: ProductionLiveEpochTransitionSettlementExecutionRecoveryOutcome = recover_exec
            .recover_live_epoch_transition_settlement_execution_window(None, current_artifact);
