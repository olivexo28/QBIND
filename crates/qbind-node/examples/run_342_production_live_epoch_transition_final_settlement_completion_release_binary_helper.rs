...
mod run_341_final_settlement_completion {
    ...
    pub fn helper_main() {
        ...
        ("accepted_compatible", "accept_artifact_reexposes_consumed_settlement_execution_transcript", accept_artifact_reexposes_consumed_settlement_execution_transcript as fn()),
        ...
        ("rejection_fail_closed", "wrong_settlement_execution_decision_id", wrong_settlement_execution_decision_id as fn()),
        ("rejection_fail_closed", "wrong_settlement_execution_request_id", wrong_settlement_execution_request_id as fn()),
        ("rejection_fail_closed", "wrong_settlement_execution_intent_digest", wrong_settlement_execution_intent_digest as fn()),
        ("rejection_fail_closed", "wrong_settlement_execution_transcript_digest", wrong_settlement_execution_transcript_digest as fn()),
        ("rejection_fail_closed", "wrong_settlement_execution_nonce", wrong_settlement_execution_nonce as fn()),
        ("rejection_fail_closed", "tampered_settlement_execution_package_integrity_mismatch", tampered_settlement_execution_package_integrity_mismatch as fn()),
        ...
        ("rejection_fail_closed", "reject_missing_settlement_execution_decision", reject_missing_settlement_execution_decision as fn()),
        ("rejection_fail_closed", "reject_unverified_settlement_execution_decision", reject_unverified_settlement_execution_decision as fn()),
        ...
        ("rejection_fail_closed", "reject_accepted_settlement_execution_without_package_via_verified_source", reject_accepted_settlement_execution_without_package_via_verified_source as fn()),
        ("rejection_fail_closed", "reject_accepted_settlement_execution_without_package_variant", reject_accepted_settlement_execution_without_package_variant as fn()),
        ...
        ("rejection_fail_closed", "reject_fixture_only_settlement_execution", reject_fixture_only_settlement_execution as fn()),
        ...
        accepted_body.push_str(&format!("final_settlement_completion_id={}\n", accepted_decision.final_settlement_completion_id));
        ...
        accepted_body.push_str(&format!("final_settlement_completion_digest={}\n", accepted_decision.final_settlement_completion_digest));
        ...
        assert_eq!(digest_decision_1.final_settlement_completion_id, digest_decision_2.final_settlement_completion_id);
        ...
        assert_eq!(digest_decision_1.final_settlement_completion_digest, digest_decision_2.final_settlement_completion_digest);
        ...
        digest_body.push_str(&format!("final_settlement_completion_id={}\n", digest_decision_1.final_settlement_completion_id));
        ...
        digest_body.push_str(&format!("second_final_settlement_completion_digest={}\n", digest_decision_2.final_settlement_completion_digest));
        ...
        let recover_exec = ProductionLiveEpochTransitionFinalSettlementCompletionExecutor::source_test();
        let current_artifact: &ProductionLiveEpochTransitionFinalSettlementCompletionArtifact = accepted_artifact;
        let clean: ProductionLiveEpochTransitionFinalSettlementCompletionRecoveryOutcome =
            recover_exec.recover_live_epoch_transition_final_settlement_completion_window(None, current_artifact);
