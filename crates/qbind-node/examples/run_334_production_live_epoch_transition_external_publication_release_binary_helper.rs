...
fn main() {
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        ("accepted_compatible", "accept_artifact_reexposes_consumed_durable_audit_publication_transcript", accept_artifact_reexposes_consumed_durable_audit_publication_transcript as fn()),
        ...
        ("rejection_fail_closed", "wrong_durable_audit_publication_decision_id", wrong_durable_audit_publication_decision_id as fn()),
        ("rejection_fail_closed", "wrong_durable_audit_publication_request_id", wrong_durable_audit_publication_request_id as fn()),
        ("rejection_fail_closed", "wrong_durable_audit_publication_intent_digest", wrong_durable_audit_publication_intent_digest as fn()),
        ("rejection_fail_closed", "wrong_durable_audit_publication_transcript_digest", wrong_durable_audit_publication_transcript_digest as fn()),
        ("rejection_fail_closed", "wrong_durable_audit_publication_nonce", wrong_durable_audit_publication_nonce as fn()),
        ("rejection_fail_closed", "tampered_durable_audit_publication_package_integrity_mismatch", tampered_durable_audit_publication_package_integrity_mismatch as fn()),
        ...
        ("rejection_fail_closed", "reject_missing_durable_audit_publication_decision", reject_missing_durable_audit_publication_decision as fn()),
        ("rejection_fail_closed", "reject_unverified_durable_audit_publication_decision", reject_unverified_durable_audit_publication_decision as fn()),
        ...
        ("rejection_fail_closed", "reject_accepted_durable_audit_publication_without_package_via_verified_source", reject_accepted_durable_audit_publication_without_package_via_verified_source as fn()),
        ("rejection_fail_closed", "reject_accepted_durable_audit_publication_without_package_variant", reject_accepted_durable_audit_publication_without_package_variant as fn()),
        ...
        ("rejection_fail_closed", "reject_fixture_only_durable_audit_publication", reject_fixture_only_durable_audit_publication as fn()),
    ...
    for sc in ALL_SC {
        ...
        digest_body.push_str(&format!("external_publication_id={}\n", decision.external_publication_id));
        digest_body.push_str(&format!("request_id={}\n", decision.request_id));
        digest_body.push_str(&format!("external_publication_digest={}\n", decision.external_publication_digest));
        digest_body.push_str(&format!(
            "content_digest={}\n",
            decision
                .external_publication_artifact
    ...
    digest_body.push_str(&format!("named_external_publication_id={external_publication_id}\n"));
    ...
    let clean: ProductionLiveEpochTransitionExternalPublicationRecoveryOutcome =
        recover_exec.recover_live_epoch_transition_external_publication_window(
            None,
            current_artifact,
        );
    let idempotent: ProductionLiveEpochTransitionExternalPublicationRecoveryOutcome =
        recover_exec.recover_live_epoch_transition_external_publication_window(
    ...
    summary.push_str("run_334_production_live_epoch_transition_external_publication_release_binary_helper\n");
