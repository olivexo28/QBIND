...
fn main() {
    ...
    let cases: &[(&str, &str, fn())] = &[
        ...
        (
            "accepted_compatible",
            "a02_devnet_decision_produces_authorization",
            a02_devnet_decision_produces_authorization as fn(),
        ),
        (
            "accepted_compatible",
            "a03_testnet_decision_produces_authorization",
            a03_testnet_decision_produces_authorization as fn(),
        ),
        (
            "accepted_compatible",
            "a04_noop_authorization_accepted_non_mutating",
            a04_noop_authorization_accepted_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a05_validator_add_authorization_non_mutating",
            a05_validator_add_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a06_validator_remove_authorization_non_mutating",
            a06_validator_remove_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a07_validator_update_authorization_non_mutating",
            a07_validator_update_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a08_validator_identity_rotation_authorization_non_mutating",
            a08_validator_identity_rotation_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a09_validator_retirement_authorization_non_mutating",
            a09_validator_retirement_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a10_emergency_validator_removal_authorization_non_mutating",
            a10_emergency_validator_removal_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a11_authority_set_synchronization_authorization_non_mutating",
            a11_authority_set_synchronization_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a12_bulk_validator_set_rotation_authorization_non_mutating",
            a12_bulk_validator_set_rotation_authorization_non_mutating as fn(),
        ),
        (
            "accepted_compatible",
            "a13_authorization_binds_environment_chain_genesis_root",
            a13_authorization_binds_environment_chain_genesis_root as fn(),
        ),
        (
            "accepted_compatible",
            "a14_authorization_binds_governance_tuple",
            a14_authorization_binds_governance_tuple as fn(),
        ),
        (
            "accepted_compatible",
            "a15_authorization_binds_governance_execution_ids_and_digests",
            a15_authorization_binds_governance_execution_ids_and_digests as fn(),
        ),
        (
            "accepted_compatible",
            "a16_authorization_binds_rotation_ids_and_digests",
            a16_authorization_binds_rotation_ids_and_digests as fn(),
        ),
        (
            "accepted_compatible",
            "a17_authorization_binds_application_decision_tuple",
            a17_authorization_binds_application_decision_tuple as fn(),
        ),
        (
            "accepted_compatible",
            "a18_authorization_binds_validator_set_digests_and_versions",
            a18_authorization_binds_validator_set_digests_and_versions as fn(),
        ),
        (
            "accepted_compatible",
            "a19_authorization_binds_epoch_transition_target_and_nonces",
            a19_authorization_binds_epoch_transition_target_and_nonces as fn(),
        ),
        (
            "accepted_compatible",
            "a20_authorization_binds_quorum_threshold_policies",
            a20_authorization_binds_quorum_threshold_policies as fn(),
        ),
        (
            "accepted_compatible",
            "a21_authorization_binds_custody_attestation_durable_where_represented",
            a21_authorization_binds_custody_attestation_durable_where_represented as fn(),
        ),
        (
            "accepted_compatible",
            "a22_request_id_deterministic",
            a22_request_id_deterministic as fn(),
        ),
        (
            "accepted_compatible",
        ...
        (
            "accepted_compatible",
            "a24_transcript_digest_deterministic",
            a24_transcript_digest_deterministic as fn(),
        ),
        (
            "accepted_compatible",
            "a25_different_action_changes_intent_digest",
            a25_different_action_changes_intent_digest as fn(),
        ),
        (
            "accepted_compatible",
            "a26_different_live_application_nonce_changes_intent_digest",
            a26_different_live_application_nonce_changes_intent_digest as fn(),
        ),
        (
            "accepted_compatible",
            "a27_accept_authorizes_future_mutation_only",
            a27_accept_authorizes_future_mutation_only as fn(),
        ),
        (
            "accepted_compatible",
            "a28_accept_outcome_carries_kind_env_target_nonce",
            a28_accept_outcome_carries_kind_env_target_nonce as fn(),
        ),
        (
            "accepted_compatible",
            "a29_min_governance_epoch_at_boundary_accepts",
            a29_min_governance_epoch_at_boundary_accepts as fn(),
        ),
        (
            "accepted_compatible",
            "a30_persisted_sequence_equal_accepts",
            a30_persisted_sequence_equal_accepts as fn(),
        ),
        (
            "accepted_compatible",
            "a31_application_nonce_bound_into_intent",
            a31_application_nonce_bound_into_intent as fn(),
        ),
        (
            "rejection_fail_closed",
            "b01_missing_application_decision_rejected",
            b01_missing_application_decision_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b02_unverified_application_decision_rejected",
            b02_unverified_application_decision_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b03_unverified_application_decision_variant_rejected",
            b03_unverified_application_decision_variant_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b04_accepted_decision_without_intent_rejected",
            b04_accepted_decision_without_intent_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b05_accepted_decision_without_intent_source_rejected",
            b05_accepted_decision_without_intent_source_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b06_rotation_plan_alone_rejected",
            b06_rotation_plan_alone_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b07_governance_execution_intent_alone_rejected",
            b07_governance_execution_intent_alone_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b08_governance_proof_alone_rejected",
            b08_governance_proof_alone_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b09_local_operator_rejected",
            b09_local_operator_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b10_peer_majority_rejected",
            b10_peer_majority_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b11_custody_only_rejected",
            b11_custody_only_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b12_remote_signer_only_rejected",
            b12_remote_signer_only_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b13_custody_attestation_only_rejected",
            b13_custody_attestation_only_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b14_fixture_only_application_decision_rejected",
            b14_fixture_only_application_decision_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b15_arbitrary_validator_set_bytes_rejected",
            b15_arbitrary_validator_set_bytes_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b16_wrong_application_decision_id_rejected",
            b16_wrong_application_decision_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b17_wrong_application_request_id_rejected",
            b17_wrong_application_request_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b18_wrong_application_intent_digest_rejected",
            b18_wrong_application_intent_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b19_wrong_application_transcript_rejected",
            b19_wrong_application_transcript_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b20_tampered_application_intent_integrity_mismatch_rejected",
            b20_tampered_application_intent_integrity_mismatch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b21_wrong_application_policy_id_rejected",
            b21_wrong_application_policy_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b22_wrong_environment_rejected",
            b22_wrong_environment_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b23_wrong_chain_rejected",
            b23_wrong_chain_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b24_wrong_genesis_rejected",
            b24_wrong_genesis_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b25_wrong_authority_root_rejected",
            b25_wrong_authority_root_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b26_wrong_governance_domain_rejected",
            b26_wrong_governance_domain_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b27_wrong_governance_epoch_rejected",
            b27_wrong_governance_epoch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b28_wrong_proposal_id_rejected",
            b28_wrong_proposal_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b29_wrong_governance_decision_id_rejected",
            b29_wrong_governance_decision_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b30_wrong_governance_request_id_rejected",
            b30_wrong_governance_request_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b31_wrong_governance_intent_digest_rejected",
            b31_wrong_governance_intent_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b32_wrong_rotation_decision_id_rejected",
            b32_wrong_rotation_decision_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b33_wrong_rotation_request_id_rejected",
            b33_wrong_rotation_request_id_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b34_wrong_rotation_transcript_rejected",
            b34_wrong_rotation_transcript_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b35_wrong_rotation_plan_digest_rejected",
            b35_wrong_rotation_plan_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b36_wrong_lifecycle_action_rejected",
            b36_wrong_lifecycle_action_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b37_wrong_rotation_action_rejected",
            b37_wrong_rotation_action_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b38_wrong_authority_sequence_rejected",
            b38_wrong_authority_sequence_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b39_wrong_quorum_rejected",
            b39_wrong_quorum_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b40_wrong_threshold_rejected",
            b40_wrong_threshold_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b41_wrong_current_set_digest_rejected",
            b41_wrong_current_set_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b42_wrong_proposed_set_digest_rejected",
            b42_wrong_proposed_set_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b43_wrong_delta_digest_rejected",
            b43_wrong_delta_digest_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b44_wrong_validator_set_epoch_rejected",
            b44_wrong_validator_set_epoch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b45_wrong_validator_set_version_rejected",
            b45_wrong_validator_set_version_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b46_wrong_proposed_validator_count_rejected",
            b46_wrong_proposed_validator_count_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b47_wrong_rotation_nonce_rejected",
            b47_wrong_rotation_nonce_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b48_wrong_epoch_transition_target_request_rejected",
            b48_wrong_epoch_transition_target_request_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b49_wrong_epoch_transition_target_expected_rejected",
            b49_wrong_epoch_transition_target_expected_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b50_wrong_application_nonce_rejected",
            b50_wrong_application_nonce_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b51_custody_required_but_missing_rejected",
            b51_custody_required_but_missing_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b52_custody_mismatch_rejected",
            b52_custody_mismatch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b53_attestation_required_but_missing_rejected",
            b53_attestation_required_but_missing_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b54_attestation_mismatch_rejected",
            b54_attestation_mismatch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b55_durable_required_but_missing_rejected",
            b55_durable_required_but_missing_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b56_durable_mismatch_rejected",
            b56_durable_mismatch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b57_stale_governance_epoch_rejected",
            b57_stale_governance_epoch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b58_stale_authority_sequence_rejected",
            b58_stale_authority_sequence_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b59_stale_validator_set_epoch_rejected",
            b59_stale_validator_set_epoch_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b60_stale_validator_set_version_rejected",
            b60_stale_validator_set_version_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b61_ill_formed_inputs_rejected",
            b61_ill_formed_inputs_rejected as fn(),
        ),
        (
            "rejection_fail_closed",
            "b62_application_carried_custody_disagreement_rejected",
            b62_application_carried_custody_disagreement_rejected as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c01_mainnet_trust_domain_refused",
            c01_mainnet_trust_domain_refused as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c02_mainnet_trust_domain_no_intent",
            c02_mainnet_trust_domain_no_intent as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c03_production_policy_unavailable",
            c03_production_policy_unavailable as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c04_mainnet_policy_unavailable_on_non_mainnet",
            c04_mainnet_policy_unavailable_on_non_mainnet as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c05_mainnet_policy_on_mainnet_domain_unavailable",
            c05_mainnet_policy_on_mainnet_domain_unavailable as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c06_reserved_production_kind_unavailable",
            c06_reserved_production_kind_unavailable as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c07_disabled_kind_is_disabled",
            c07_disabled_kind_is_disabled as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c08_disabled_policy_is_disabled",
            c08_disabled_policy_is_disabled as fn(),
        ),
        (
            "mainnet_authority_policy",
            "c09_mainnet_refused_named_helper",
            c09_mainnet_refused_named_helper as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d01_replayed_authorization_id_rejected",
            d01_replayed_authorization_id_rejected as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d02_non_replayed_id_accepts",
            d02_non_replayed_id_accepts as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d03_recovery_no_prior_window_clean",
            d03_recovery_no_prior_window_clean as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d04_recovery_idempotent_replay_observed",
            d04_recovery_idempotent_replay_observed as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d05_recovery_unrelated_window_clean",
            d05_recovery_unrelated_window_clean as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d06_recovery_disabled_policy",
            d06_recovery_disabled_policy as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d07_recovery_same_window_divergent_intent_clean",
            d07_recovery_same_window_divergent_intent_clean as fn(),
        ),
        (
            "replay_recovery_idempotency",
            "d08_replay_recovery_is_deterministic",
            d08_replay_recovery_is_deterministic as fn(),
        ),
        (
            "non_mutation",
            "e01_named_helper_default_disabled",
            e01_named_helper_default_disabled as fn(),
        ),
        (
            "non_mutation",
            "e02_named_helper_source_test_not_release_binary",
            e02_named_helper_source_test_not_release_binary as fn(),
        ),
        (
            "non_mutation",
            "e03_named_helper_non_mutating",
            e03_named_helper_non_mutating as fn(),
        ),
        (
            "non_mutation",
            "e04_named_helper_never_falls_back",
            e04_named_helper_never_falls_back as fn(),
        ),
        (
            "non_mutation",
            "e05_named_helper_no_default_runtime_wiring",
            e05_named_helper_no_default_runtime_wiring as fn(),
        ),
        (
            "non_mutation",
            "e06_named_helper_requires_verified_application_decision",
            e06_named_helper_requires_verified_application_decision as fn(),
        ),
        (
            "non_mutation",
            "e07_every_outcome_is_non_mutating",
            e07_every_outcome_is_non_mutating as fn(),
        ),
        (
            "non_mutation",
            "e08_accept_is_only_mutation_authorizer",
            e08_accept_is_only_mutation_authorizer as fn(),
        ),
        (
            "non_mutation",
            "e09_disabled_is_not_reject",
            e09_disabled_is_not_reject as fn(),
        ),
        (
            "non_mutation",
            "e10_config_source_test_well_formed",
            e10_config_source_test_well_formed as fn(),
        ),
        (
            "non_mutation",
            "e11_protocol_version_supported",
            e11_protocol_version_supported as fn(),
        ),
        (
            "non_mutation",
            "e12_authorization_kind_from_application_decision_kind_roundtrip",
            e12_authorization_kind_from_application_decision_kind_roundtrip as fn(),
        ),
        (
            "non_mutation",
            "e13_intent_marked_non_mutating",
            e13_intent_marked_non_mutating as fn(),
        ),
        (
            "non_mutation",
            "e14_reject_carries_no_intent_but_has_transcript",
            e14_reject_carries_no_intent_but_has_transcript as fn(),
        ),
        (
            "non_mutation",
            "e15_all_authorization_kinds_non_mutating",
            e15_all_authorization_kinds_non_mutating as fn(),
        ),
        (
            "reachability_taxonomy",
            "f01_policy_tags_stable",
            f01_policy_tags_stable as fn(),
        ),
        (
            "reachability_taxonomy",
            "f02_kind_tags_stable",
            f02_kind_tags_stable as fn(),
        ),
        (
            "reachability_taxonomy",
            "f03_authorization_kind_tags_stable",
            f03_authorization_kind_tags_stable as fn(),
        ),
        (
            "reachability_taxonomy",
            "f04_outcome_tags_stable",
            f04_outcome_tags_stable as fn(),
        ),
        (
            "reachability_taxonomy",
            "f05_policy_predicates",
            f05_policy_predicates as fn(),
        ),
        (
            "reachability_taxonomy",
            "f06_source_test_executor_shape",
            f06_source_test_executor_shape as fn(),
        ),
        (
            "reachability_taxonomy",
            "f07_request_new_has_no_evidence_bindings",
            f07_request_new_has_no_evidence_bindings as fn(),
        ),
        (
            "reachability_taxonomy",
            "f08_testnet_and_devnet_have_distinct_intent_digests",
            f08_testnet_and_devnet_have_distinct_intent_digests as fn(),
        ),
        (
            "reachability_taxonomy",
            "f09_accept_across_all_supported_actions",
            f09_accept_across_all_supported_actions as fn(),
        ),
        (
            "reachability_taxonomy",
            "f10_recovery_outcome_non_mutating",
            f10_recovery_outcome_non_mutating as fn(),
        ),
        (
            "reachability_taxonomy",
