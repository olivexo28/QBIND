...
use qbind_node::pqc_governance_durable_completion_external_publication_audit_finalization::{
    ...
    DurableCompletionExternalPublicationAuditFinalizationWindow,
    ExternalExternalPublicationAuditFinalizationSink,
    ...
    MainNetExternalPublicationAuditFinalizationSink,
...
fn assert_fault_no_acknowledgement(
    ...
    let mut ledger = DurableCompletionExternalPublicationAuditFinalizationLedger::new();
    let mut sink =
        FixtureDurableCompletionExternalPublicationAuditFinalizationSink::with_fault(fault);
    let outcome = evaluate_durable_completion_external_publication_audit_finalization(
        &input,
        &c.expectations,
        &mut sink,
...
fn release_symbol_reachability_probe() {
    ...
    assert!(
        DurableCompletionExternalPublicationAuditFinalizationKind::FixtureInMemory.is_fixture()
    );
