// Run 288 — durable-completion external-publication-receipt consumer /
...
// boundary. Only a Run 288 ExternalPublicationAuditSealRecorded outcome
...
use qbind_node::pqc_governance_durable_completion_external_publication_audit_anchor::{
    ...
    durable_completion_external_publication_audit_anchor_completion_report_required,
    durable_completion_external_publication_audit_anchor_external_unavailable,
    durable_completion_external_publication_audit_anchor_failed_record_never_records,
    ...
    durable_completion_external_publication_audit_anchor_mainnet_peer_driven_apply_refused_first,
    ...
    durable_completion_external_publication_audit_anchor_never_writes_sequence_or_marker,
    durable_completion_external_publication_audit_anchor_no_external_publication,
    durable_completion_external_publication_audit_anchor_no_real_audit_ledger,
    durable_completion_external_publication_audit_anchor_no_rocksdb_file_schema_migration_change,
    durable_completion_external_publication_audit_anchor_peer_majority_cannot_satisfy_mainnet_authority,
    durable_completion_external_publication_audit_anchor_pipeline_success_required,
    durable_completion_external_publication_audit_anchor_policy_change_unsupported,
    durable_completion_external_publication_audit_anchor_production_mainnet_unavailable,
    durable_completion_external_publication_audit_anchor_receipt_required,
    durable_completion_external_publication_audit_anchor_record_required_before_reported,
    durable_completion_external_publication_audit_anchor_rejection_is_non_mutating,
    durable_completion_external_publication_audit_anchor_rollback_never_records,
...
const AUDIT_FINALIZATION_RECORD_ID: &str =
    "durable-completion-external-publication-audit-anchor-0001";
...
struct ActionLabel {
    ...
    external_publication_audit_anchor_record_id: String,
    proposal_id: String,
    decision_id: String,
...
fn action_label(label: &str) -> ActionLabel {
    ActionLabel {
        ...
        external_publication_audit_anchor_record_id: format!(
            "durable-completion-external-publication-audit-anchor-{label}"
        ),
...
fn default_action() -> ActionLabel {
    ActionLabel {
        ...
        external_publication_audit_anchor_record_id: AUDIT_FINALIZATION_RECORD_ID.to_string(),
...
// ===========================================================================
// Run 288 external_publication_audit_seal attachment (prior boundary)
// Builds a REAL Run 288 recorded outcome from the Run 280 prior. Uses the real
// Run 288 module field names so the Run 288 cur-layer can consume it.
// ===========================================================================
#[allow(dead_code)]
...
struct AttachedExternalPublicationAuditSeal {
...
fn run288_confirmation_identity() -> DurableCompletionExternalPublicationAuditSealIdentity {
    DurableCompletionExternalPublicationAuditSealIdentity {
        confirmation_id: ACKNOWLEDGEMENT_ID.to_string(),
        kind: DurableCompletionExternalPublicationAuditSealKind::FixtureInMemory,
        policy: DurableCompletionExternalPublicationAuditSealPolicy::FixtureAllowed,
        domain_separation_tag: ACKNOWLEDGEMENT_DOMAIN_TAG.to_string(),
    }
}

fn attach_run286_external_publication_audit_seal(
    environment: TrustBundleEnvironment,
    action: &ActionLabel,
    confirmation_duplicate: bool,
) -> AttachedExternalPublicationAuditSeal {
    let external_publication_audit_archive =
        attach_run286_external_publication_audit_archive(environment, action, false);
    ...
    let input = DurableCompletionExternalPublicationAuditSealInput {
        ...
        acknowledgement_binding: ack.outcome.clone(),
        consumer_binding: consumer.outcome.clone(),
        external_publication_audit_archive_binding: external_publication_audit_archive.outcome.clone(),
        request,
    };
    ...
    let record = ledger
        .find(&action.external_publication_audit_seal_record_id)
...
struct Ctx {
    ...
    consumer: AttachedConsumer,
    external_publication_audit_seal: AttachedExternalPublicationAuditSeal,
}

fn ack_identity(
    policy: DurableCompletionExternalPublicationAuditAnchorPolicy,
...
fn ctx_action(
    ...
    let external_publication_audit_seal =
        attach_run286_external_publication_audit_seal(environment, action, consumer_duplicate);
    let consumer = external_publication_audit_seal.consumer.clone();
    let ack = &consumer.ack;
    let env = ModeledGovernanceTrustMutationEnvironmentBinding {
        environment,
        chain_id: CHAIN.to_string(),
...
impl Ctx {
    ...
    fn input_with_confirmation(
        ...
        external_publication_audit_anchor: GovernanceModeledDurableCompletionFinalizationOutcome,
        ...
        external_publication_audit_seal: DurableCompletionExternalPublicationAuditSealOutcome,
    ) -> DurableCompletionExternalPublicationAuditAnchorInput {
        DurableCompletionExternalPublicationAuditAnchorInput {
            policy,
            ...
            confirmation_binding: external_publication_audit_anchor,
            ...
            external_publication_audit_seal_binding: external_publication_audit_seal,
    ...
    fn input(
        ...
        self.input_with_confirmation(
            ...
            sink,
            reporter,
            external_publication_audit_anchor,
            attestation,
            backend,
            self.consumer.ack.receipt.outcome.clone(),
            self.consumer.ack.outcome.clone(),
            self.consumer.outcome.clone(),
            self.external_publication_audit_seal.outcome.clone(),
        )
    }

    fn recorded(&self) -> DurableCompletionExternalPublicationAuditAnchorInput {
        self.input_with_confirmation(
...
fn devnet_ctx() -> Ctx {
    ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditAnchorPolicy::FixtureAllowed,
...
fn fixture_sink() -> FixtureDurableCompletionExternalPublicationAuditAnchorSink {
    FixtureDurableCompletionExternalPublicationAuditAnchorSink::new()
}
#[test]
fn disabled_receipt_policy_preserves_legacy_bypass_no_record_no_invocation() {
    let c = devnet_ctx();
    let input = c.input(
        DurableCompletionExternalPublicationAuditAnchorPolicy::Disabled,
        DurableReplayObservation::MutationAuthorized,
        GovernanceModeledEndToEndPipelineOutcome::ModeledApplierAppliedAndDurableConsumeAuthorized,
        GovernanceModeledDurableConsumeSinkOutcome::ConsumeReceiptRecorded,
        GovernanceModeledDurableConsumeCompletionReporterOutcome::CompletionReportRecorded,
    ...
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = fixture_sink();
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::LegacyBypassNoExternalPublicationAuditAnchor
    );
...
fn devnet_fixture_chain_records_exactly_one_receipt_only_after_backend_submission() {
    ...
    assert_eq!(
        external_publication_audit_anchor_identity_digest(&c.request.identity),
...
fn governance_action_variants_record_only_after_backend_submission() {
    ...
    for label in [
        ...
        assert_eq!(ledger.len(), 1);
        assert!(ledger.contains(&action.external_publication_audit_anchor_record_id));
    }
}
...
fn duplicate_identical_receipt_is_idempotent() {
    ...
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = fixture_sink();
    let first = evaluate_durable_completion_external_publication_audit_anchor(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    let second = evaluate_durable_completion_external_publication_audit_anchor(
        &input,
        &c.expectations,
        &mut sink,
        &mut ledger,
    ...
    assert_eq!(
        second,
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorDuplicateIdempotent
    );
    assert!(!external_publication_audit_anchor_outcome_authorizes_record(&second));
    assert!(external_publication_audit_anchor_outcome_projects_to_recorded(&second));
    assert_eq!(ledger.len(), 1);
}

#[test]
fn run268_duplicate_idempotent_confirmation_only_matches_existing_never_creates() {
    // A real Run 288 ExternalPublicationAuditSealDuplicateIdempotent outcome with
    // identical digests.
    ...
    assert_eq!(
        dup_ctx.external_publication_audit_seal.outcome,
        DurableCompletionExternalPublicationAuditSealOutcome::ExternalPublicationAuditSealDuplicateIdempotent
    );
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorRejectedBeforeRecord
    );
    assert!(ledger.is_empty());

    // After a real receipt records, the duplicate-idempotent backend matches it.
    let rec_ctx = devnet_ctx();
    let recorded = evaluate_durable_completion_external_publication_audit_anchor(
        &rec_ctx.recorded(),
    ...
    let matched = evaluate_durable_completion_external_publication_audit_anchor(
        &dup_ctx.recorded(),
        &dup_ctx.expectations,
        &mut sink,
        &mut ledger,
...
fn production_audit_ledger_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditAnchorPolicy::ProductionExternalPublicationAuditAnchorRequired,
        DurableCompletionExternalPublicationAuditAnchorKind::ProductionExternalPublicationAuditAnchorUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = ProductionExternalPublicationAuditAnchorSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn mainnet_audit_ledger_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditAnchorPolicy::MainNetExternalPublicationAuditAnchorRequired,
        DurableCompletionExternalPublicationAuditAnchorKind::MainNetExternalPublicationAuditAnchorUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = MainNetExternalPublicationAuditAnchorSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn external_publication_path_reachable_but_unavailable_records_nothing() {
    let c = ctx(
        ...
        GovernanceExecutionRuntimeSurface::ReloadApply,
        GovernanceExecutionRuntimeSurface::ReloadApply,
        DurableCompletionExternalPublicationAuditAnchorPolicy::ExternalExternalPublicationAuditAnchorRequired,
        DurableCompletionExternalPublicationAuditAnchorKind::ExternalExternalPublicationAuditAnchorUnavailable,
    );
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = ExternalExternalPublicationAuditAnchorSink::default();
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &c.recorded(),
        &c.expectations,
        &mut sink,
...
fn mainnet_peer_driven_apply_refused_before_receipt_sink_invocation() {
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::MainNetPeerDrivenApplyRefusedNoAuditAnchor
    );
...
fn validator_set_rotation_and_policy_change_unsupported() {
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::ValidatorSetRotationUnsupportedNoAuditAnchor
    );
    assert_eq!(sink.invocations(), 0);
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::PolicyChangeUnsupportedNoAuditAnchor
    );
    assert_eq!(sink.invocations(), 0);
    assert!(ledger.is_empty());
}
...
fn assert_non_recording_confirmation(
    external_publication_audit_seal: DurableCompletionExternalPublicationAuditSealOutcome,
    expected: DurableCompletionExternalPublicationAuditAnchorOutcome,
) {
    let c = devnet_ctx();
    let input = c.input_with_confirmation(
        DurableCompletionExternalPublicationAuditAnchorPolicy::FixtureAllowed,
...
fn non_recording_confirmation_outcomes_never_record_external_publication_audit_anchor() {
    ...
    assert_non_recording_confirmation(
        ...
        Receipt::RejectedBeforeExternalPublicationAuditSealNoAuditAnchor,
    );
    assert_non_recording_confirmation(
    ...
    assert_non_recording_confirmation(
        Finalization::ProductionExternalPublicationAuditSealUnavailableNoAuditSeal,
        Receipt::ExternalPublicationAuditSealDidNotRecordNoAuditAnchor,
    );
    assert_non_recording_confirmation(
        Finalization::MainNetExternalPublicationAuditSealUnavailableNoAuditSeal,
        Receipt::ExternalPublicationAuditSealDidNotRecordNoAuditAnchor,
    );
    assert_non_recording_confirmation(
        Finalization::ExternalExternalPublicationAuditSealUnavailableNoAuditSeal,
        Receipt::ExternalPublicationAuditSealDidNotRecordNoAuditAnchor,
    );
    assert_non_recording_confirmation(
        Finalization::MainNetPeerDrivenApplyRefusedNoAuditSeal,
        Receipt::MainNetPeerDrivenApplyRefusedNoAuditAnchor,
    );
    assert_non_recording_confirmation(
        Finalization::ValidatorSetRotationUnsupportedNoAuditSeal,
        Receipt::ValidatorSetRotationUnsupportedNoAuditAnchor,
    );
    assert_non_recording_confirmation(
        Finalization::PolicyChangeUnsupportedNoAuditSeal,
        Receipt::PolicyChangeUnsupportedNoAuditAnchor,
    );
}
...
fn assert_binding_mismatch_rejected(mut mutate: impl FnMut(&mut Ctx)) {
    ...
    assert_eq!(
        outcome,
        DurableCompletionExternalPublicationAuditAnchorOutcome::RejectedBeforeExternalPublicationAuditSealNoAuditAnchor
    );
    assert_eq!(sink.invocations(), 0);
    assert!(ledger.is_empty());
}
...
fn assert_request_mismatch_rejected(
    mut mutate: impl FnMut(&mut DurableCompletionExternalPublicationAuditAnchorRequest),
) {
    let c = devnet_ctx();
...
#[test]
fn wrong_external_publication_audit_anchor_record_id_rejected_before_record() {
    assert_request_mismatch_rejected(|r| {
        r.external_publication_audit_anchor_record_id = "other-confirmation".to_string();
    });
}
...
fn same_ack_record_id_different_digest_is_equivocation_no_second_receipt() {
    ...
    let equivocation = evaluate_durable_completion_external_publication_audit_anchor(
        &c2.recorded(),
        &c2.expectations,
        &mut sink,
        &mut ledger,
...
fn assert_fault_no_acknowledgement(
    fault: DurableCompletionExternalPublicationAuditAnchorFault,
    expected: DurableCompletionExternalPublicationAuditAnchorOutcome,
) {
    let c = devnet_ctx();
    let input = c.recorded();
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = FixtureDurableCompletionExternalPublicationAuditAnchorSink::with_fault(fault);
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &input,
        &c.expectations,
        &mut sink,
...
fn receipt_record_failed_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorRecordFailedNoAuditAnchor,
    );
}
...
fn receipt_rollback_completed_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorRolledBackNoAuditAnchor,
    );
}
...
fn receipt_rollback_failed_fatal_never_records() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorRollbackFailedFatalNoAuditAnchor,
    );
}
...
fn receipt_ambiguous_window_fails_closed() {
    assert_fault_no_acknowledgement(
        ...
        DurableCompletionExternalPublicationAuditAnchorOutcome::ExternalPublicationAuditAnchorAmbiguousFailClosedNoAuditAnchor,
    );
}
...
fn only_recorded_confirmation_outcome_creates_external_publication_audit_anchor_request_intent() {
    ...
    assert!(project_external_publication_audit_seal_outcome_to_external_publication_audit_anchor_request(
        &Finalization::ExternalPublicationAuditSealRecorded
    )
    .creates_request());
    assert_eq!(
        project_external_publication_audit_seal_outcome_to_external_publication_audit_anchor_request(
            &Finalization::ExternalPublicationAuditSealDuplicateIdempotent
        ),
...
fn non_recording_confirmation_outcomes_create_no_external_publication_audit_anchor_request() {
    ...
    for confirmation in [
        ...
        assert!(matches!(
            project_external_publication_audit_seal_outcome_to_external_publication_audit_anchor_request(&confirmation),
            Intent::NoReceipt(_)
        ));
    }
}
...
fn recovered_ledger() -> DurableCompletionExternalPublicationAuditAnchorLedger {
    let c = devnet_ctx();
    let mut ledger = DurableCompletionExternalPublicationAuditAnchorLedger::new();
    let mut sink = fixture_sink();
    let _ = evaluate_durable_completion_external_publication_audit_anchor(
        &c.recorded(),
        &c.expectations,
        &mut sink,
        &mut ledger,
...
fn assert_window(
    ...
    let outcome = recover_durable_completion_external_publication_audit_anchor_window(
        &input,
        window,
        DurableCompletionExternalPublicationAuditAnchorKind::FixtureInMemory,
        record,
...
#[test]
fn pre_external_publication_audit_seal_windows_fail_closed_no_commitment() {
    ...
    for w in [
        ...
        assert_window(
            w,
            false,
            Finalization::ExternalPublicationAuditSealDidNotRecordNoAuditAnchor,
        );
    }
}

#[test]
fn after_external_publication_audit_seal_request_before_record_rejects_before_record() {
    use DurableCompletionExternalPublicationAuditAnchorOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditAnchorWindow as Window;
    assert_window(
        Window::AfterExternalPublicationAuditAnchorRequestBeforeExternalPublicationAuditAnchorRecord,
        false,
        Finalization::ExternalPublicationAuditAnchorRejectedBeforeRecord,
    );
}

#[test]
fn after_external_publication_audit_seal_record_before_success_requires_explicit_matching_record() {
    use DurableCompletionExternalPublicationAuditAnchorOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditAnchorWindow as Window;
    assert_window(
    ...
    assert_window(
        Window::AfterExternalPublicationAuditAnchorRecordBeforeExternalPublicationAuditAnchorSuccess,
        true,
        Finalization::ExternalPublicationAuditAnchorRecorded,
    );
}

#[test]
fn after_external_publication_audit_seal_success_recovers_as_recorded() {
    use DurableCompletionExternalPublicationAuditAnchorOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditAnchorWindow as Window;
    assert_window(
        Window::AfterExternalPublicationAuditAnchorSuccess,
        true,
        Finalization::ExternalPublicationAuditAnchorRecorded,
    );
...
fn ambiguous_record_failed_rollback_and_unknown_windows_fail_closed() {
    ...
    assert_window(
        ...
        false,
        Finalization::ExternalPublicationAuditAnchorAmbiguousFailClosedNoAuditAnchor,
    );
    assert_window(
        Window::Unknown,
        false,
    ...
    assert_window(
        ...
        false,
        Finalization::ExternalPublicationAuditAnchorRecordFailedNoAuditAnchor,
    );
    assert_window(
        Window::ExternalPublicationAuditAnchorRollbackCompleted,
        false,
        Finalization::ExternalPublicationAuditAnchorRolledBackNoAuditAnchor,
    );
    assert_window(
        Window::ExternalPublicationAuditAnchorRollbackFailed,
        false,
        Finalization::ExternalPublicationAuditAnchorRollbackFailedFatalNoAuditAnchor,
    );
}
...
fn production_mainnet_external_recovery_classification_unavailable() {
    ...
    let outcome = recover_durable_completion_external_publication_audit_anchor_window(
        &input,
        DurableCompletionExternalPublicationAuditAnchorWindow::AfterExternalPublicationAuditAnchorSuccess,
        DurableCompletionExternalPublicationAuditAnchorKind::ProductionExternalPublicationAuditAnchorUnavailable,
        None,
        &c.expectations,
    );
...
fn rollback_restores_receipt_ledger_snapshot() {
    ...
    let mut faulted = FixtureDurableCompletionExternalPublicationAuditAnchorSink::with_fault(
        DurableCompletionExternalPublicationAuditAnchorFault::RolledBackNoReceipt,
    );
    let outcome = evaluate_durable_completion_external_publication_audit_anchor(
        &c2.recorded(),
...
fn invariant_helpers_assert_fail_closed_contract() {
    ...
    assert!(durable_completion_external_publication_audit_anchor_no_real_audit_ledger());
    ...
    assert!(durable_completion_external_publication_audit_anchor_record_required_before_reported());
    assert!(durable_completion_external_publication_audit_anchor_failed_record_never_records());
    assert!(durable_completion_external_publication_audit_anchor_rollback_never_records());
    assert!(durable_completion_external_publication_audit_anchor_ambiguous_window_fails_closed());
    assert!(
        durable_completion_external_publication_audit_anchor_mainnet_peer_driven_apply_refused_first(
            TrustBundleEnvironment::Mainnet
        )
