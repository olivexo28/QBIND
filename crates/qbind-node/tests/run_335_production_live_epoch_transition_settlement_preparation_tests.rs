//! Run 335 — source/test **live epoch-transition settlement /
//! finalization-preparation** boundary integration tests.
//!
//! Source/test only. Run 335 does **not** capture release-binary evidence;
//! release-binary evidence for the live epoch-transition settlement /
//! finalization-preparation boundary is deferred to **Run 336**.
//!
//! Each accepted case composes the real Run 303 -> 305 -> 307 -> 309 -> 311 ->
//! 313 -> 315 -> 317 -> 319 -> 321 -> 323 -> 325 -> 327 -> 329 -> 331 -> 333
//! chain to produce a verified, accepted Run 333 live epoch-transition
//! external-publication decision, then feeds that decision into the Run 335
//! live epoch-transition settlement / finalization-preparation executor.
//!
//! Run 335 produces **only** a typed, non-mutating settlement /
//! finalization-preparation artifact. It never applies a live
...
//! production settlement / external-publication record, and
