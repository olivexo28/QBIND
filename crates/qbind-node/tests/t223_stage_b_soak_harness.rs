...
//! The legacy `QBIND_MAINNET_AUDIT_SKELETON.md` reference was retired by
//! EXE-1 (B4 in `docs/protocol/QBIND_REPO_CODE_DOC_ALIGNMENT_AUDIT.md`); the
//! current authoritative MainNet readiness gates live in
