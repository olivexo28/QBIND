// Run 276 — durable-completion settlement-outcome publication consumer /
// external-publication-confirmation boundary tests.
//
// Source/test-only modeled boundary that sits one rung above the Run 274
// settlement-outcome publication boundary. The chain attaches the real Run 256
...
// settlement-outcome report, and Run 274 settlement-outcome publication records,
// then evaluates the Run 276 external-publication-confirmation boundary. Only a
// Run 276 ExternalPublicationConfirmationRecorded outcome authorizes new state;
// every ambiguous, missing, duplicate, or mismatched window fails closed.
