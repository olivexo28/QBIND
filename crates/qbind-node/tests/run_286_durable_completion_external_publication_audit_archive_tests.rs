// Run 284 — durable-completion external-publication-receipt consumer /
// external-publication-audit-completion boundary tests.
//
...
// records, then evaluates the Run 284 external-publication-audit-completion
// boundary. Only a Run 284 ExternalPublicationAuditCompletionRecorded outcome
...
const ACKNOWLEDGEMENT_ID: &str = "fixture-external-publication-audit-completion-0001";
...
const AUDIT_FINALIZATION_ID: &str = "fixture-external-publication-audit-archive-0001";
...
// Builds a REAL Run 284 recorded outcome from the Run 280 prior. Uses the real
// Run 284 module field names so the Run 284 cur-layer can consume it.
// ===========================================================================
#[allow(dead_code)]
...
fn non_recording_confirmation_outcomes_create_no_external_publication_audit_archive_request() {
    ...
    for confirmation in [
        ...
        assert!(matches!(
            project_external_publication_audit_completion_outcome_to_external_publication_audit_archive_request(&confirmation),
            Intent::NoReceipt(_)
        ));
    }
}
...
#[test]
fn pre_external_publication_audit_completion_windows_fail_closed_no_commitment() {
...
#[test]
fn after_external_publication_audit_completion_request_before_record_rejects_before_record() {
    use DurableCompletionExternalPublicationAuditArchiveOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditArchiveWindow as Window;
    assert_window(
...
#[test]
fn after_external_publication_audit_completion_record_before_success_requires_explicit_matching_record() {
    use DurableCompletionExternalPublicationAuditArchiveOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditArchiveWindow as Window;
    assert_window(
...
#[test]
fn after_external_publication_audit_completion_success_recovers_as_recorded() {
    use DurableCompletionExternalPublicationAuditArchiveOutcome as Finalization;
    use DurableCompletionExternalPublicationAuditArchiveWindow as Window;
    assert_window(
