...
//!    - File: `crates/qbind-node/src/consensus_network_facade.rs`
...
//!    - File: `crates/qbind-consensus/src/basic_hotstuff_engine.rs:790-803`
...
//!    - File: `crates/qbind-consensus/src/driver.rs:311-316`
...
//!    - Files: Various test files in `crates/qbind-node/tests/`
...
//!
//! ```bash
//! cargo test -p qbind-node --test three_node_byzantine_leader_tests
//! ```
...
async fn run_scenario_b_invalid_proposals(_config: ByzantineTestConfig) -> ByzantineTestResult {
    ...
    let expected_suite: u16 = qbind_wire::DEFAULT_CONSENSUS_SUITE_ID;
...
mod unit_tests {
    use super::*;
    use qbind_node::NullNetworkFacade;
