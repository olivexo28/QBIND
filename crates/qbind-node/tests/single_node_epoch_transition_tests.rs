...
fn detect_reconfig_proposal() {
    ...
    // Check payload kind
    let is_normal_reconfig = normal.header.payload_kind == qbind_wire::PAYLOAD_KIND_RECONFIG;
    let is_reconfig_reconfig = reconfig.header.payload_kind == qbind_wire::PAYLOAD_KIND_RECONFIG;
