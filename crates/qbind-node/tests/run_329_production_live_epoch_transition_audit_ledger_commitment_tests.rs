//! Run 329 — source/test **live epoch-transition audit-ledger commitment /
//! durable-audit publication preparation** boundary integration tests.
//!
//! Source/test only. Run 329 does **not** capture release-binary evidence;
//! release-binary evidence for the live epoch-transition audit-ledger
//! commitment / durable-audit publication preparation boundary is deferred to
//! **Run 330**.
//!
//! Each accepted case composes the real Run 303 -> 305 -> 307 -> 309 -> 311 ->
//! 313 -> 315 -> 317 -> 319 -> 321 -> 323 -> 325 -> 327 chain to produce a
//! verified, accepted Run 327 live epoch-transition durable-audit-finalization
//! decision, then feeds that decision into the Run 329 live epoch-transition
//! audit-ledger commitment / durable-audit publication preparation executor.
//!
//! Run 329 produces **only** a typed, non-mutating audit-ledger-commitment /
//! durable-audit-publication-preparation artifact. It never applies a live
...
//! production audit-ledger commitment / audit-ledger record, and never mutates
//! any durable trust state. The only mutation a positive path performs is
