//! Run 333 — source/test **live epoch-transition external-publication /
//! settlement-preparation** boundary integration tests.
//!
//! Source/test only. Run 333 does **not** capture release-binary evidence;
//! release-binary evidence for the live epoch-transition external-publication /
//! settlement-preparation boundary is deferred to **Run 334**.
//!
//! Each accepted case composes the real Run 303 -> 305 -> 307 -> 309 -> 311 ->
//! 313 -> 315 -> 317 -> 319 -> 321 -> 323 -> 325 -> 327 -> 329 -> 331 chain to
//! produce a verified, accepted Run 331 live epoch-transition
//! durable-audit-publication decision, then feeds that decision into the Run 333
//! live epoch-transition external-publication / settlement-preparation executor.
//!
//! Run 333 produces **only** a typed, non-mutating external-publication /
//! settlement-preparation artifact. It never applies a live
...
//! production external-publication / settlement record, and
