//! Run 331 — source/test **live epoch-transition durable-audit publication /
//! external-publication preparation** boundary integration tests.
//!
//! Source/test only. Run 331 does **not** capture release-binary evidence;
//! release-binary evidence for the live epoch-transition durable-audit
//! publication / external-publication preparation boundary is deferred to
//! **Run 332**.
//!
//! Each accepted case composes the real Run 303 -> 305 -> 307 -> 309 -> 311 ->
//! 313 -> 315 -> 317 -> 319 -> 321 -> 323 -> 325 -> 327 -> 329 chain to produce
//! a verified, accepted Run 329 live epoch-transition audit-ledger-commitment
//! decision, then feeds that decision into the Run 331 live epoch-transition
//! durable-audit publication / external-publication preparation executor.
//!
//! Run 331 produces **only** a typed, non-mutating durable-audit-publication /
//! external-publication-preparation artifact. It never applies a live
...
//! production durable-audit publication / external-publication record, and
//! never mutates any durable trust state. The only mutation a positive path
