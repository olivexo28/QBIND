...
use cano_consensus::governed_key_registry::{ConsensusKeyGovernance, GovernedValidatorKeyRegistry};
use cano_consensus::verify::{ConsensusVerifier, VerificationError};
use cano_consensus::{MultiSuiteCryptoVerifier, SimpleBackendRegistry, ValidatorId};
use cano_crypto::consensus_sig::{ConsensusSigError, ConsensusSigVerifier};
use cano_crypto::{ConsensusSigSuiteId, SUITE_TOY_SHA3};
...
fn simple_backend_registry_basic_operations() {
    use cano_consensus::ConsensusSigBackendRegistry;
