...
//!
//! ```bash
//! cargo test -p cano-consensus --test consensus_pqc_metrics_tests -- --test-threads=1
//! ```
//!
...
use cano_crypto::consensus_sig::{ConsensusSigError, ConsensusSigSuiteId, ConsensusSigVerifier};
use cano_crypto::{suite_name, SUITE_PQ_RESERVED_1, SUITE_TOY_SHA3};
