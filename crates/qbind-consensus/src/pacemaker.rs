...
//!
//! ```
//! use qbind_consensus::pacemaker::{Pacemaker, PacemakerConfig, BasicTickPacemaker};
//!
...
//!
//! ```
//! use qbind_consensus::pacemaker::{TimeoutPacemaker, TimeoutPacemakerConfig, PacemakerEvent};
