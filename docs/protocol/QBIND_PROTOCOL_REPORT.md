...
1. **O3–O5 slashing penalties pending — O1/O2 enforced (M9); O3 (invalid vote), O4 (censorship), O5 (availability) remain evidence-only** - No economic deterrent for misbehavior
