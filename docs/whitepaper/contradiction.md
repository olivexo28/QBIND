...
| Field | Value |
|-------|-------|
| **Status** | ⚠️ **OPEN — partial** (B1, B2, B3 (VM-v0 state restore), **B5 (restore-aware consensus start)** landed; multi-validator P2P binary-path interconnect still outstanding) |
