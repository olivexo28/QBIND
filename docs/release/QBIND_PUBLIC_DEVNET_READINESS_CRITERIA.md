...
- **Yellow (must reach Green):** M4 (seed/bootnodes — format+placeholder landed Run 357, external reachability
  still not proven Run 378/388, so still a launch blocker until live seeds + reachability evidence land),
