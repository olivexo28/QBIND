...
`ubuntu-s-1vcpu-1gb-sgp1`, listening `0.0.0.0:30333`) from a genuinely independent off-host dialer on a
different network (Laptop 1 WSL, host `olivegigi`, observed public egress `110.226.112.166`), under
